...
if __name__ == "__main__":
    ...
    parser.add_argument("--board", help="Choose a board name", default="example_json")
    parser.add_argument("--can_data_dir", help="Path to JSON CAN data", default="C:/Users/80419/formula/Consolidated-Firmware/scripts/code_generation/jsoncan/example_json")
    parser.add_argument("--output_dir", help="Path to the output source files", default=".")
    parser.add_argument("--dbc_output", help="Path to the DBC file", default=".")
    parser.add_argument(
