Set-Variable GENERATED_DIR "./example_generated"
Set-Variable GENERATED_APP_DIR "${GENERATED_DIR}/app"
Set-Variable GENERATED_IO_DIR "${GENERATED_DIR}/io"
Set-Variable GENERATED_DBC_DIR "${GENERATED_DIR}/dbc"
