...
#define CANSIG_JCT_STATUS_JCT_UNSIGNED_TESTER_START_VAL (-2047) // V
...
#define CANSIG_JCT_STATUS_JCT_UNSIGNED_TESTER_MIN (-2047) // V
#define CANSIG_JCT_STATUS_JCT_UNSIGNED_TESTER_MAX (2046) // V
