use crate::can_database::RxMsgIDs;
...
pub fn parse_json_rx_data(can_data_dir: &str, rx_node_name: &str) -> RxMsgIDs {
    ...
    match json_rx_msgs.messages {
        ...
        JsonRxEntry::RxMsgs(msg_list) => RxMsgIDs::RxMsgs(msg_list.into_iter().collect()),
    }
}
