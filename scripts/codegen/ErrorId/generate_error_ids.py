...
#define JSONCANTest_NON_CRITICAL_ERRORS \\
{jsoncantest_non_critical_errors}
...
#define JSONCANTest_AIR_SHUTDOWN_ERRORS \\
{jsoncantest_air_shutdown_errors}
...
#define JSONCANTest_MOTOR_SHUTDOWN_ERRORS \\
{jsoncantest_motor_shutdown_errors}
...
if __name__ == "__main__":
    ...
    enum = ERRORID_ENUM_TEMPLATE.format(
        ...
        jsoncantest_non_critical_errors   = '\n'.join(enum_members['non_critical']['JSONCANTest']),
        ...
        jsoncantest_air_shutdown_errors   = '\n'.join(enum_members['air_shutdown']['JSONCANTest']),
        ...
        jsoncantest_motor_shutdown_errors   = '\n'.join(enum_members['motor_shutdown']['JSONCANTest']))
