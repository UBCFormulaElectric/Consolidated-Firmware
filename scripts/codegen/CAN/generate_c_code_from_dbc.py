...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help='Path to output CAN TX source file for the App layer')
    parser.add_argument(
        '--app_can_tx_header_output',
        help='Path to output CAN TX header file for the App layer')
    parser.add_argument(
        '--io_can_tx_source_output',
        help='Path to output CAN TX source file for the IO layer')
    parser.add_argument(
        '--io_can_tx_header_output',
        help='Path to output CAN TX header file for the IO layer')
    parser.add_argument(
        '--app_can_rx_source_output',
        help='Path to output CAN RX source file for the App layer')
    parser.add_argument(
        '--app_can_rx_header_output',
        help='Path to output CAN RX header file for the App layer')
    parser.add_argument(
