...
/**
 * Update value stored in TX table of signal FSM_StackRemainingTask1Hz in msg FSM_StackRemaining.
 */
void App_CanTx_FSM_StackRemainingTask1Hz_Set(uint32_t value);

/**
 * Update value stored in TX table of signal FSM_StackRemainingTask100Hz in msg FSM_StackRemaining.
 */
void App_CanTx_FSM_StackRemainingTask100Hz_Set(uint32_t value);

/**
 * Update value stored in TX table of signal FSM_StackRemainingTask1kHz in msg FSM_StackRemaining.
 */
void App_CanTx_FSM_StackRemainingTask1kHz_Set(uint32_t value);

/**
 * Update value stored in TX table of signal FSM_StackRemainingTaskCanRx in msg FSM_StackRemaining.
 */
void App_CanTx_FSM_StackRemainingTaskCanRx_Set(uint32_t value);

/**
 * Update value stored in TX table of signal FSM_StackRemainingTaskCanTx in msg FSM_StackRemaining.
 */
...
/**
 * Return value from TX table of signal FSM_StackRemainingTask1Hz in msg FSM_StackRemaining.
 */
uint32_t App_CanTx_FSM_StackRemainingTask1Hz_Get(void);

/**
 * Return value from TX table of signal FSM_StackRemainingTask100Hz in msg FSM_StackRemaining.
 */
uint32_t App_CanTx_FSM_StackRemainingTask100Hz_Get(void);

/**
 * Return value from TX table of signal FSM_StackRemainingTask1kHz in msg FSM_StackRemaining.
 */
uint32_t App_CanTx_FSM_StackRemainingTask1kHz_Get(void);

/**
 * Return value from TX table of signal FSM_StackRemainingTaskCanRx in msg FSM_StackRemaining.
 */
uint32_t App_CanTx_FSM_StackRemainingTaskCanRx_Get(void);

/**
 * Return value from TX table of signal FSM_StackRemainingTaskCanTx in msg FSM_StackRemaining.
 */
uint32_t App_CanTx_FSM_StackRemainingTaskCanTx_Get(void);
...
/**
 * Returns pointer to the struct of msg FSM_StackRemaining signals in the TX table.
 */
const FSM_StackRemaining_Signals* App_CanTx_FSM_StackRemaining_GetData(void);
