...
typedef struct
{
    ...
    GSM_StackRemaining_Signals GSM_StackRemaining_signals;
...
void App_CanTx_Init()
{
    ...
    App_CanTx_GSM_StackRemainingTask1Hz_Set(CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK1_HZ_START_VAL);
    App_CanTx_GSM_StackRemainingTask100Hz_Set(CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK100_HZ_START_VAL);
    App_CanTx_GSM_StackRemainingTask1kHz_Set(CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK1K_HZ_START_VAL);
    App_CanTx_GSM_StackRemainingTaskCanRx_Set(CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK_CAN_RX_START_VAL);
    App_CanTx_GSM_StackRemainingTaskCanTx_Set(CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK_CAN_TX_START_VAL);
...
{
    tx_table.GSM_StackRemaining_signals.GSM_StackRemainingTask1Hz_value = (value > CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK1_HZ_MAX) ? CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK1_HZ_MAX : value;
}

void App_CanTx_GSM_StackRemainingTask100Hz_Set(uint32_t value)
{
    tx_table.GSM_StackRemaining_signals.GSM_StackRemainingTask100Hz_value = (value > CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK100_HZ_MAX) ? CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK100_HZ_MAX : value;
}

void App_CanTx_GSM_StackRemainingTask1kHz_Set(uint32_t value)
{
    tx_table.GSM_StackRemaining_signals.GSM_StackRemainingTask1kHz_value = (value > CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK1K_HZ_MAX) ? CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK1K_HZ_MAX : value;
}

void App_CanTx_GSM_StackRemainingTaskCanRx_Set(uint32_t value)
{
    tx_table.GSM_StackRemaining_signals.GSM_StackRemainingTaskCanRx_value = (value > CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK_CAN_RX_MAX) ? CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK_CAN_RX_MAX : value;
}

void App_CanTx_GSM_StackRemainingTaskCanTx_Set(uint32_t value)
{
    tx_table.GSM_StackRemaining_signals.GSM_StackRemainingTaskCanTx_value = (value > CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK_CAN_TX_MAX) ? CANSIG_GSM_STACK_REMAINING_GSM_STACK_REMAINING_TASK_CAN_TX_MAX : value;
}
...
uint32_t App_CanTx_GSM_StackRemainingTask1Hz_Get()
{
    return tx_table.GSM_StackRemaining_signals.GSM_StackRemainingTask1Hz_value;
}

uint32_t App_CanTx_GSM_StackRemainingTask100Hz_Get()
{
    return tx_table.GSM_StackRemaining_signals.GSM_StackRemainingTask100Hz_value;
}

uint32_t App_CanTx_GSM_StackRemainingTask1kHz_Get()
{
    return tx_table.GSM_StackRemaining_signals.GSM_StackRemainingTask1kHz_value;
}

uint32_t App_CanTx_GSM_StackRemainingTaskCanRx_Get()
{
    return tx_table.GSM_StackRemaining_signals.GSM_StackRemainingTaskCanRx_value;
}

uint32_t App_CanTx_GSM_StackRemainingTaskCanTx_Get()
{
    return tx_table.GSM_StackRemaining_signals.GSM_StackRemainingTaskCanTx_value;
}
...
const GSM_StackRemaining_Signals* App_CanTx_GSM_StackRemaining_GetData()
{
    return &tx_table.GSM_StackRemaining_signals;
}
