...
{
    // Pack 5-byte payload for message DIM_StackRemaining.
    ...
    // Pack 7-bit signal DIM_StackRemainingTask1Hz into payload (at bit 0 to bit 7).
    const uint32_t DIM_StackRemainingTask1Hz_val = in_msg->DIM_StackRemainingTask1Hz_value;
    const uint32_t DIM_StackRemainingTask1Hz_raw = CAN_ENCODE(DIM_StackRemainingTask1Hz_val, CANSIG_DIM_STACK_REMAINING_DIM_STACK_REMAINING_TASK1_HZ_SCALE, CANSIG_DIM_STACK_REMAINING_DIM_STACK_REMAINING_TASK1_HZ_OFFSET, uint32_t);
    out_data[0] |= packShiftRight(DIM_StackRemainingTask1Hz_raw, 0, 0x7f);   // Packs bits _####### of byte 0
    
    // Pack 7-bit signal DIM_StackRemainingTask100Hz into payload (at bit 7 to bit 14).
    const uint32_t DIM_StackRemainingTask100Hz_val = in_msg->DIM_StackRemainingTask100Hz_value;
    const uint32_t DIM_StackRemainingTask100Hz_raw = CAN_ENCODE(DIM_StackRemainingTask100Hz_val, CANSIG_DIM_STACK_REMAINING_DIM_STACK_REMAINING_TASK100_HZ_SCALE, CANSIG_DIM_STACK_REMAINING_DIM_STACK_REMAINING_TASK100_HZ_OFFSET, uint32_t);
    out_data[0] |= packShiftLeft(DIM_StackRemainingTask100Hz_raw, 7, 0x80);   // Packs bits #_______ of byte 0
    out_data[1] |= packShiftRight(DIM_StackRemainingTask100Hz_raw, 1, 0x3f);   // Packs bits __###### of byte 1
    
    // Pack 7-bit signal DIM_StackRemainingTask1kHz into payload (at bit 14 to bit 21).
    const uint32_t DIM_StackRemainingTask1kHz_val = in_msg->DIM_StackRemainingTask1kHz_value;
    const uint32_t DIM_StackRemainingTask1kHz_raw = CAN_ENCODE(DIM_StackRemainingTask1kHz_val, CANSIG_DIM_STACK_REMAINING_DIM_STACK_REMAINING_TASK1K_HZ_SCALE, CANSIG_DIM_STACK_REMAINING_DIM_STACK_REMAINING_TASK1K_HZ_OFFSET, uint32_t);
    out_data[1] |= packShiftLeft(DIM_StackRemainingTask1kHz_raw, 6, 0xc0);   // Packs bits ##______ of byte 1
    out_data[2] |= packShiftRight(DIM_StackRemainingTask1kHz_raw, 2, 0x1f);   // Packs bits ___##### of byte 2
    
    // Pack 7-bit signal DIM_StackRemainingTaskCanRx into payload (at bit 21 to bit 28).
    const uint32_t DIM_StackRemainingTaskCanRx_val = in_msg->DIM_StackRemainingTaskCanRx_value;
    const uint32_t DIM_StackRemainingTaskCanRx_raw = CAN_ENCODE(DIM_StackRemainingTaskCanRx_val, CANSIG_DIM_STACK_REMAINING_DIM_STACK_REMAINING_TASK_CAN_RX_SCALE, CANSIG_DIM_STACK_REMAINING_DIM_STACK_REMAINING_TASK_CAN_RX_OFFSET, uint32_t);
    out_data[2] |= packShiftLeft(DIM_StackRemainingTaskCanRx_raw, 5, 0xe0);   // Packs bits ###_____ of byte 2
    out_data[3] |= packShiftRight(DIM_StackRemainingTaskCanRx_raw, 3, 0xf);   // Packs bits ____#### of byte 3
    
    // Pack 7-bit signal DIM_StackRemainingTaskCanTx into payload (at bit 28 to bit 35).
    const uint32_t DIM_StackRemainingTaskCanTx_val = in_msg->DIM_StackRemainingTaskCanTx_value;
    const uint32_t DIM_StackRemainingTaskCanTx_raw = CAN_ENCODE(DIM_StackRemainingTaskCanTx_val, CANSIG_DIM_STACK_REMAINING_DIM_STACK_REMAINING_TASK_CAN_TX_SCALE, CANSIG_DIM_STACK_REMAINING_DIM_STACK_REMAINING_TASK_CAN_TX_OFFSET, uint32_t);
    out_data[3] |= packShiftLeft(DIM_StackRemainingTaskCanTx_raw, 4, 0xf0);   // Packs bits ####____ of byte 3
    out_data[4] |= packShiftRight(DIM_StackRemainingTaskCanTx_raw, 4, 0x7);   // Packs bits _____### of byte 4
