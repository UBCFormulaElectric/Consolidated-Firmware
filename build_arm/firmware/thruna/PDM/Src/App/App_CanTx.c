...
typedef struct
{
    ...
    PDM_StackRemaining_Signals PDM_StackRemaining_signals;
...
void App_CanTx_Init()
{
    ...
    App_CanTx_PDM_StackRemainingTask1Hz_Set(CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK1_HZ_START_VAL);
    App_CanTx_PDM_StackRemainingTask100Hz_Set(CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK100_HZ_START_VAL);
    App_CanTx_PDM_StackRemainingTask1kHz_Set(CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK1K_HZ_START_VAL);
    App_CanTx_PDM_StackRemainingTaskCanRx_Set(CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK_CAN_RX_START_VAL);
    App_CanTx_PDM_StackRemainingTaskCanTx_Set(CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK_CAN_TX_START_VAL);
...
{
    tx_table.PDM_StackRemaining_signals.PDM_StackRemainingTask1Hz_value = (value > CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK1_HZ_MAX) ? CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK1_HZ_MAX : value;
}

void App_CanTx_PDM_StackRemainingTask100Hz_Set(uint32_t value)
{
    tx_table.PDM_StackRemaining_signals.PDM_StackRemainingTask100Hz_value = (value > CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK100_HZ_MAX) ? CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK100_HZ_MAX : value;
}

void App_CanTx_PDM_StackRemainingTask1kHz_Set(uint32_t value)
{
    tx_table.PDM_StackRemaining_signals.PDM_StackRemainingTask1kHz_value = (value > CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK1K_HZ_MAX) ? CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK1K_HZ_MAX : value;
}

void App_CanTx_PDM_StackRemainingTaskCanRx_Set(uint32_t value)
{
    tx_table.PDM_StackRemaining_signals.PDM_StackRemainingTaskCanRx_value = (value > CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK_CAN_RX_MAX) ? CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK_CAN_RX_MAX : value;
}

void App_CanTx_PDM_StackRemainingTaskCanTx_Set(uint32_t value)
{
    tx_table.PDM_StackRemaining_signals.PDM_StackRemainingTaskCanTx_value = (value > CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK_CAN_TX_MAX) ? CANSIG_PDM_STACK_REMAINING_PDM_STACK_REMAINING_TASK_CAN_TX_MAX : value;
}
...
uint32_t App_CanTx_PDM_StackRemainingTask1Hz_Get()
{
    return tx_table.PDM_StackRemaining_signals.PDM_StackRemainingTask1Hz_value;
}

uint32_t App_CanTx_PDM_StackRemainingTask100Hz_Get()
{
    return tx_table.PDM_StackRemaining_signals.PDM_StackRemainingTask100Hz_value;
}

uint32_t App_CanTx_PDM_StackRemainingTask1kHz_Get()
{
    return tx_table.PDM_StackRemaining_signals.PDM_StackRemainingTask1kHz_value;
}

uint32_t App_CanTx_PDM_StackRemainingTaskCanRx_Get()
{
    return tx_table.PDM_StackRemaining_signals.PDM_StackRemainingTaskCanRx_value;
}

uint32_t App_CanTx_PDM_StackRemainingTaskCanTx_Get()
{
    return tx_table.PDM_StackRemaining_signals.PDM_StackRemainingTaskCanTx_value;
}
...
const PDM_StackRemaining_Signals* App_CanTx_PDM_StackRemaining_GetData()
{
    return &tx_table.PDM_StackRemaining_signals;
}
