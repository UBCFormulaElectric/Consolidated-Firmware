...
void App_CanAlerts_PDM_Warning_StackWaterMarkHighTask1Hz_Set(bool set_alert)
{
    ...
    if (set_alert && !App_CanTx_PDM_Warning_StackWaterMarkHighTask1Hz_Get())
    {
        App_CanTx_PDM_Warning_StackWaterMarkHighTask1HzCount_Set(App_CanTx_PDM_Warning_StackWaterMarkHighTask1HzCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_Warning_StackWaterMarkHighTask1Hz_Set(set_alert);
}

void App_CanAlerts_PDM_Warning_StackWaterMarkHighTask100Hz_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_Warning_StackWaterMarkHighTask100Hz_Get())
    {
        App_CanTx_PDM_Warning_StackWaterMarkHighTask100HzCount_Set(App_CanTx_PDM_Warning_StackWaterMarkHighTask100HzCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_Warning_StackWaterMarkHighTask100Hz_Set(set_alert);
}

void App_CanAlerts_PDM_Warning_StackWaterMarkHighTask1kHz_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_Warning_StackWaterMarkHighTask1kHz_Get())
    {
        App_CanTx_PDM_Warning_StackWaterMarkHighTask1kHzCount_Set(App_CanTx_PDM_Warning_StackWaterMarkHighTask1kHzCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_Warning_StackWaterMarkHighTask1kHz_Set(set_alert);
}

void App_CanAlerts_PDM_Warning_StackWaterMarkHighTaskCanRx_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanRx_Get())
    {
        App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanRxCount_Set(App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanRxCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanRx_Set(set_alert);
}

void App_CanAlerts_PDM_Warning_StackWaterMarkHighTaskCanTx_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanTx_Get())
    {
        App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanTxCount_Set(App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanTxCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanTx_Set(set_alert);
}

void App_CanAlerts_PDM_Warning_WatchdogTimeout_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_Warning_WatchdogTimeout_Get())
    {
        App_CanTx_PDM_Warning_WatchdogTimeoutCount_Set(App_CanTx_PDM_Warning_WatchdogTimeoutCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_Warning_WatchdogTimeout_Set(set_alert);
}

void App_CanAlerts_PDM_Warning_TxOverflow_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_Warning_TxOverflow_Get())
    {
        App_CanTx_PDM_Warning_TxOverflowCount_Set(App_CanTx_PDM_Warning_TxOverflowCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_Warning_TxOverflow_Set(set_alert);
}

void App_CanAlerts_PDM_Warning_RxOverflow_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_Warning_RxOverflow_Get())
    {
        App_CanTx_PDM_Warning_RxOverflowCount_Set(App_CanTx_PDM_Warning_RxOverflowCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_Warning_RxOverflow_Set(set_alert);
}

void App_CanAlerts_PDM_Fault_DummyFault_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_Fault_DummyFault_Get())
    {
        App_CanTx_PDM_Fault_DummyFaultCount_Set(App_CanTx_PDM_Fault_DummyFaultCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_Fault_DummyFault_Set(set_alert);
}

bool App_CanAlerts_PDM_Warning_StackWaterMarkHighTask1Hz_Get()
{
    return App_CanTx_PDM_Warning_StackWaterMarkHighTask1Hz_Get();
}

bool App_CanAlerts_PDM_Warning_StackWaterMarkHighTask100Hz_Get()
{
    return App_CanTx_PDM_Warning_StackWaterMarkHighTask100Hz_Get();
}

bool App_CanAlerts_PDM_Warning_StackWaterMarkHighTask1kHz_Get()
{
    return App_CanTx_PDM_Warning_StackWaterMarkHighTask1kHz_Get();
}

bool App_CanAlerts_PDM_Warning_StackWaterMarkHighTaskCanRx_Get()
{
    return App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanRx_Get();
}

bool App_CanAlerts_PDM_Warning_StackWaterMarkHighTaskCanTx_Get()
{
    return App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanTx_Get();
}

bool App_CanAlerts_PDM_Warning_WatchdogTimeout_Get()
{
    return App_CanTx_PDM_Warning_WatchdogTimeout_Get();
}

bool App_CanAlerts_PDM_Warning_TxOverflow_Get()
{
    return App_CanTx_PDM_Warning_TxOverflow_Get();
}

bool App_CanAlerts_PDM_Warning_RxOverflow_Get()
{
    return App_CanTx_PDM_Warning_RxOverflow_Get();
}

bool App_CanAlerts_PDM_Fault_DummyFault_Get()
{
    return App_CanTx_PDM_Fault_DummyFault_Get();
}
...
bool App_CanAlerts_BoardHasWarning(CanAlertBoard board)
{
    switch (board)
    {
        ...
        {
            if (App_CanTx_PDM_Warning_StackWaterMarkHighTask1Hz_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_Warning_StackWaterMarkHighTask100Hz_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_Warning_StackWaterMarkHighTask1kHz_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanRx_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_Warning_StackWaterMarkHighTaskCanTx_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_Warning_WatchdogTimeout_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_Warning_TxOverflow_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_Warning_RxOverflow_Get())
            {
                return true;
            }
...
bool App_CanAlerts_BoardHasFault(CanAlertBoard board)
{
    switch (board)
    {
        ...
        case PDM_ALERT_BOARD:
        {
            if (App_CanTx_PDM_Fault_DummyFault_Get())
            {
                return true;
            }
