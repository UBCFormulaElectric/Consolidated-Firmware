...
/**
 * Update value stored in TX table of signal DCM_StackRemainingTask1Hz in msg DCM_StackRemaining.
 */
void App_CanTx_DCM_StackRemainingTask1Hz_Set(uint32_t value);

/**
 * Update value stored in TX table of signal DCM_StackRemainingTask100Hz in msg DCM_StackRemaining.
 */
void App_CanTx_DCM_StackRemainingTask100Hz_Set(uint32_t value);

/**
 * Update value stored in TX table of signal DCM_StackRemainingTask1kHz in msg DCM_StackRemaining.
 */
void App_CanTx_DCM_StackRemainingTask1kHz_Set(uint32_t value);

/**
 * Update value stored in TX table of signal DCM_StackRemainingTaskCanRx in msg DCM_StackRemaining.
 */
void App_CanTx_DCM_StackRemainingTaskCanRx_Set(uint32_t value);

/**
 * Update value stored in TX table of signal DCM_StackRemainingTaskCanTx in msg DCM_StackRemaining.
 */
...
/**
 * Return value from TX table of signal DCM_StackRemainingTask1Hz in msg DCM_StackRemaining.
 */
uint32_t App_CanTx_DCM_StackRemainingTask1Hz_Get(void);

/**
 * Return value from TX table of signal DCM_StackRemainingTask100Hz in msg DCM_StackRemaining.
 */
uint32_t App_CanTx_DCM_StackRemainingTask100Hz_Get(void);

/**
 * Return value from TX table of signal DCM_StackRemainingTask1kHz in msg DCM_StackRemaining.
 */
uint32_t App_CanTx_DCM_StackRemainingTask1kHz_Get(void);

/**
 * Return value from TX table of signal DCM_StackRemainingTaskCanRx in msg DCM_StackRemaining.
 */
uint32_t App_CanTx_DCM_StackRemainingTaskCanRx_Get(void);

/**
 * Return value from TX table of signal DCM_StackRemainingTaskCanTx in msg DCM_StackRemaining.
 */
uint32_t App_CanTx_DCM_StackRemainingTaskCanTx_Get(void);
...
/**
 * Returns pointer to the struct of msg DCM_StackRemaining signals in the TX table.
 */
const DCM_StackRemaining_Signals* App_CanTx_DCM_StackRemaining_GetData(void);
