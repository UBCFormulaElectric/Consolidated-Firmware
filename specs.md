...
FSM-9 | Wheel speed reporting | - The FSM must report the two front wheel speeds in km/h over CAN at 1kHz or faster. <br/> - The FSM must send a non-critical fault when either front wheel speed is above 150km/h.
