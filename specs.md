...
BMS-36 | IMD data transmission | The BMS must transit the high/low status of the IMD's OK_HS output, the information encoded in the IMD's PWM output, and the number of seconds elapsed since the IMD is powered on.
