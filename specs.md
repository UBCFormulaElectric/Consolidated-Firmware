...
FSM-9 | Wheel speed reporting | - The FSM must report the two front wheel speeds in km/h over CAN at 1kHz. <br/> - The FSM must send a non-critical fault when either front wheel speed is inactive or above 150km/h.
...
DIM-12 | State CAN message | The DCM must transmit the state of its state machine at 100Hz.
