...
impl Subscriptions {
    ...
    /**
     * Unsubscribe client from all signals
     */
    pub fn unsubscribe_client(&mut self, client: String) {
...
mod tests {
    ...
    fn test_unsubscribe_client_from_all_signals() {
        ...
        subs.unsubscribe_client("client1".to_string());
    ...
    fn test_unsubscribe_nonexistent_client() {
        ...
        subs.unsubscribe_client("nonexistent".to_string());
