...
# Absolute path to the directory containing the json_can_parsing module
module_dir = 'Consolidated-Firmware/scripts/code_generation/jsoncan/src/json_parsing'
# Add this directory to sys.path
if module_dir not in sys.path:
    sys.path.append(module_dir)
# Now you can import the module
import json_can_parsing
