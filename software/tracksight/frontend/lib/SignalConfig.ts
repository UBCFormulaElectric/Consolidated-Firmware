...
export type AlertSignalType = AlertType | "FaultCount" | "WarningCount" | "InfoCount";
...
export const BACKEND_URL = typeof window !== "undefined" ? `http://${window.location.hostname}:${backend_port}` : `http://localhost:${backend_port}`;
