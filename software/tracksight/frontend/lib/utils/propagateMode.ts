...
const propagateMode = (buffer: ModeLodBuffer[], level: number, timestamp: number, incomingCounts: Record<number, number>, callback: (level: number, intervalMs: number, timestamp: number, value: number) => void, maxLevels: number): void => {
