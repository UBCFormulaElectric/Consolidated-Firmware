...
const propagateHaar = (buffer: HaarLodBuffer[], level: number, timestamp: number, value: number, callback: (level: number, intervalMs: number, timestamp: number, value: number) => void, maxLevels: number): void => {
