import FLASK_URL from "../../app/page";

// honestly not sure we will be using this again since this was for saving loadouts for dashboards. ended up being pointless since
// internet connection was needed for it to wokr, but keeping it around in case.
