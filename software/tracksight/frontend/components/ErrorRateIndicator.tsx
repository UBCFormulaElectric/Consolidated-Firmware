    ...
    return (
        <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="relative flex items-center px-3 py-1 rounded-md transition-colors hover:bg-gray-50 cursor-default">
            ...
            <div className={`w-1.5 h-6 rounded-full overflow-hidden bg-gray-100`}>
                <div className={`w-full transition-all duration-500 ${value !== null && value > 5 ? "bg-red-500" : value !== null && value > 1 ? "bg-yellow-500" : "bg-green-500"}`} style={{ height: `${value !== null ? Math.min(100, value * 10) : 0}%`, marginTop: "auto" }} />
            </div>
                ...
                <div className="absolute top-full right-0 mt-1 p-3 bg-white rounded-lg shadow-xl border border-gray-100 z-[60] animate-in fade-in slide-in-from-top-1 duration-200">
                    <div className="flex flex-col items-center">
                        <svg width="100" height="20" className="overflow-visible">
                            <polyline fill="none" stroke={value !== null && value > 5 ? "#ef4444" : value !== null && value > 1 ? "#eab308" : "#22c55e"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" points={sparklinePoints} />
                        </svg>
