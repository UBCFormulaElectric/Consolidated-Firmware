...
const SDCardFileNavigator = (props: SDCardFileNavigatorProps) => {
    ...
    return (
        <div className="w-full h-full flex flex-row gap-8">
            <SDCardFileList files={files} selectedFiles={selectedFiles} onToggleFile={handleToggleFile} isLoading={isLoadingFiles} noSDCardSelected={noSDCardSelected} hasError={hasError} />
            <SDCardFileInfo
