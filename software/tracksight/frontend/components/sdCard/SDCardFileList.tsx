        ...
        <SDCardFileListFrame>
            <div className="flex flex-col">
                {files.map((file) => {
                    ...
                    return (
                        <div key={file} className={`h-min p-4 select-none border-b flex flex-row items-center gap-4 border-black w-full hover:cursor-pointer ${isSelected ? "bg-blue-100" : "hover:bg-blue-100/50"}`} onClick={() => onToggleFile(file)}>
