...
CAN_DATA_DIR="$ROOT_DIR/can_bus/quintuna"
OUT_DIR="$DIMOS_DIR/native/jsoncan_gen/quintuna/DAMLogger"
...
PYTHONPATH="$ROOT_DIR/scripts/code_generation" \
  ...
  --dbc_output "$TMP_DIR/quintuna.dbc" \
  --board DAMLogger \
...
cp "$TMP_DIR/quintuna.dbc" "$OUT_DIR/"
