...
typedef enum
{
    DIM_Warning_StackWaterMarkHighTask1Hz = 0,
    DIM_Warning_StackWaterMarkHighTask100Hz = 1,
    DIM_Warning_StackWaterMarkHighTask1kHz = 2,
    DIM_Warning_StackWaterMarkHighTaskCanRx = 3,
    DIM_Warning_StackWaterMarkHighTaskCanTx = 4,
    DIM_Warning_WatchdogTimeout = 5,
    DIM_Warning_TxOverflow = 6,
    DIM_Warning_RxOverflow = 7,
    NUM_DIM_WARNINGS = 8,
} DIM_WarningId;

typedef enum
{
    DIM_Fault_MissingHeartbeat = 0,
    NUM_DIM_FAULTS = 1,
} DIM_FaultId;
 ...
 */
bool App_CanAlerts_DIM_Warning_StackWaterMarkHighTask1Hz_Get(void);

/**
 * Return whether or not a specific alert transmitted by this board is set.
 */
bool App_CanAlerts_DIM_Warning_StackWaterMarkHighTask100Hz_Get(void);

/**
 * Return whether or not a specific alert transmitted by this board is set.
 */
bool App_CanAlerts_DIM_Warning_StackWaterMarkHighTask1kHz_Get(void);

/**
 * Return whether or not a specific alert transmitted by this board is set.
 */
bool App_CanAlerts_DIM_Warning_StackWaterMarkHighTaskCanRx_Get(void);

/**
 * Return whether or not a specific alert transmitted by this board is set.
 */
bool App_CanAlerts_DIM_Warning_StackWaterMarkHighTaskCanTx_Get(void);

/**
 * Return whether or not a specific alert transmitted by this board is set.
 */
bool App_CanAlerts_DIM_Warning_WatchdogTimeout_Get(void);

/**
 * Return whether or not a specific alert transmitted by this board is set.
 */
bool App_CanAlerts_DIM_Warning_TxOverflow_Get(void);

/**
 * Return whether or not a specific alert transmitted by this board is set.
 */
bool App_CanAlerts_DIM_Warning_RxOverflow_Get(void);

/**
 * Return whether or not a specific alert transmitted by this board is set.
 */
bool App_CanAlerts_DIM_Fault_MissingHeartbeat_Get(void);
