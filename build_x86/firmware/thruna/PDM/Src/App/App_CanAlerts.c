...
void App_CanAlerts_PDM_StackWaterMarkHighTask1HzWarning_Set(bool set_alert)
{
    ...
    if (set_alert && !App_CanTx_PDM_StackWaterMarkHighTask1HzWarning_Get())
    {
        App_CanTx_PDM_StackWaterMarkHighTask1HzWarningCount_Set(App_CanTx_PDM_StackWaterMarkHighTask1HzWarningCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_StackWaterMarkHighTask1HzWarning_Set(set_alert);
}

void App_CanAlerts_PDM_StackWaterMarkHighTask100HzWarning_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_StackWaterMarkHighTask100HzWarning_Get())
    {
        App_CanTx_PDM_StackWaterMarkHighTask100HzWarningCount_Set(App_CanTx_PDM_StackWaterMarkHighTask100HzWarningCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_StackWaterMarkHighTask100HzWarning_Set(set_alert);
}

void App_CanAlerts_PDM_StackWaterMarkHighTask1kHzWarning_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_StackWaterMarkHighTask1kHzWarning_Get())
    {
        App_CanTx_PDM_StackWaterMarkHighTask1kHzWarningCount_Set(App_CanTx_PDM_StackWaterMarkHighTask1kHzWarningCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_StackWaterMarkHighTask1kHzWarning_Set(set_alert);
}

void App_CanAlerts_PDM_StackWaterMarkHighTaskCanRxWarning_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_StackWaterMarkHighTaskCanRxWarning_Get())
    {
        App_CanTx_PDM_StackWaterMarkHighTaskCanRxWarningCount_Set(App_CanTx_PDM_StackWaterMarkHighTaskCanRxWarningCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_StackWaterMarkHighTaskCanRxWarning_Set(set_alert);
}

void App_CanAlerts_PDM_StackWaterMarkHighTaskCanTxWarning_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_StackWaterMarkHighTaskCanTxWarning_Get())
    {
        App_CanTx_PDM_StackWaterMarkHighTaskCanTxWarningCount_Set(App_CanTx_PDM_StackWaterMarkHighTaskCanTxWarningCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_StackWaterMarkHighTaskCanTxWarning_Set(set_alert);
}

void App_CanAlerts_PDM_WatchdogTimeoutWarning_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_WatchdogTimeoutWarning_Get())
    {
        App_CanTx_PDM_WatchdogTimeoutWarningCount_Set(App_CanTx_PDM_WatchdogTimeoutWarningCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_WatchdogTimeoutWarning_Set(set_alert);
}

void App_CanAlerts_PDM_TxOverflowWarning_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_TxOverflowWarning_Get())
    {
        App_CanTx_PDM_TxOverflowWarningCount_Set(App_CanTx_PDM_TxOverflowWarningCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_TxOverflowWarning_Set(set_alert);
}

void App_CanAlerts_PDM_RxOverflowWarning_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_RxOverflowWarning_Get())
    {
        App_CanTx_PDM_RxOverflowWarningCount_Set(App_CanTx_PDM_RxOverflowWarningCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_RxOverflowWarning_Set(set_alert);
}

void App_CanAlerts_PDM_DummyFault_Set(bool set_alert)
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_PDM_DummyFault_Get())
    {
        App_CanTx_PDM_DummyFaultCount_Set(App_CanTx_PDM_DummyFaultCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_PDM_DummyFault_Set(set_alert);
}

bool App_CanAlerts_PDM_StackWaterMarkHighTask1HzWarning_Get()
{
    return App_CanTx_PDM_StackWaterMarkHighTask1HzWarning_Get();
}

bool App_CanAlerts_PDM_StackWaterMarkHighTask100HzWarning_Get()
{
    return App_CanTx_PDM_StackWaterMarkHighTask100HzWarning_Get();
}

bool App_CanAlerts_PDM_StackWaterMarkHighTask1kHzWarning_Get()
{
    return App_CanTx_PDM_StackWaterMarkHighTask1kHzWarning_Get();
}

bool App_CanAlerts_PDM_StackWaterMarkHighTaskCanRxWarning_Get()
{
    return App_CanTx_PDM_StackWaterMarkHighTaskCanRxWarning_Get();
}

bool App_CanAlerts_PDM_StackWaterMarkHighTaskCanTxWarning_Get()
{
    return App_CanTx_PDM_StackWaterMarkHighTaskCanTxWarning_Get();
}

bool App_CanAlerts_PDM_WatchdogTimeoutWarning_Get()
{
    return App_CanTx_PDM_WatchdogTimeoutWarning_Get();
}

bool App_CanAlerts_PDM_TxOverflowWarning_Get()
{
    return App_CanTx_PDM_TxOverflowWarning_Get();
}

bool App_CanAlerts_PDM_RxOverflowWarning_Get()
{
    return App_CanTx_PDM_RxOverflowWarning_Get();
}

bool App_CanAlerts_PDM_DummyFault_Get()
{
    return App_CanTx_PDM_DummyFault_Get();
}
...
bool App_CanAlerts_BoardHasWarning(CanAlertBoard board)
{
    switch (board)
    {
        ...
        {
            if (App_CanTx_PDM_StackWaterMarkHighTask1HzWarning_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_StackWaterMarkHighTask100HzWarning_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_StackWaterMarkHighTask1kHzWarning_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_StackWaterMarkHighTaskCanRxWarning_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_StackWaterMarkHighTaskCanTxWarning_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_WatchdogTimeoutWarning_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_TxOverflowWarning_Get())
            {
                return true;
            }
            
            if (App_CanTx_PDM_RxOverflowWarning_Get())
            {
                return true;
            }
...
bool App_CanAlerts_BoardHasFault(CanAlertBoard board)
{
    switch (board)
    {
        ...
        case PDM_ALERT_BOARD:
        {
            if (App_CanTx_PDM_DummyFault_Get())
            {
                return true;
            }
