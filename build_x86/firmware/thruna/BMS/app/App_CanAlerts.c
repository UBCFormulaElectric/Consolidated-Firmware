...
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_BMS_Fault_MissingHeartbeat_Get())
    {
        App_CanTx_BMS_Fault_MissingHeartbeatCount_Set(App_CanTx_BMS_Fault_MissingHeartbeatCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_BMS_Fault_MissingHeartbeat_Set(set_alert);
}
...
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_BMS_Fault_Charger_Get())
    {
        App_CanTx_BMS_Fault_ChargerCount_Set(App_CanTx_BMS_Fault_ChargerCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_BMS_Fault_Charger_Set(set_alert);
}
...
{
    // Increment alert counter.
    if (set_alert && !App_CanTx_BMS_Fault_ChargerExternalShutdown_Get())
    {
        App_CanTx_BMS_Fault_ChargerExternalShutdownCount_Set(App_CanTx_BMS_Fault_ChargerExternalShutdownCount_Get() + 1);
    }
    
    // Set alert.
    App_CanTx_BMS_Fault_ChargerExternalShutdown_Set(set_alert);
}
...
bool App_CanAlerts_BMS_Fault_MissingHeartbeat_Get()
{
    return App_CanTx_BMS_Fault_MissingHeartbeat_Get();
}
...
bool App_CanAlerts_BMS_Fault_Charger_Get()
{
    return App_CanTx_BMS_Fault_Charger_Get();
}
...
bool App_CanAlerts_BMS_Fault_ChargerExternalShutdown_Get()
{
    return App_CanTx_BMS_Fault_ChargerExternalShutdown_Get();
}
...
bool App_CanAlerts_BoardHasFault(CanAlertBoard board)
{
    switch (board)
    {
        ...
        case BMS_ALERT_BOARD:
        {
            if (App_CanTx_BMS_Fault_MissingHeartbeat_Get())
            {
                return true;
            }
            ...
            if (App_CanTx_BMS_Fault_Charger_Get())
            {
                return true;
            }
            ...
            if (App_CanTx_BMS_Fault_ChargerExternalShutdown_Get())
            {
                return true;
            }
