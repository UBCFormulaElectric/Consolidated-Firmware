...
void GPIO_ConfigurePreChargeComplete(volatile uint8_t *fault_states)
{
    ...
    HAL_GPIO_WritePin(EFUSE_DEN_1_GPIO_Port, EFUSE_DEN_1_Pin, GPIO_PIN_SET);
    ...
    HAL_GPIO_WritePin(EFUSE_DEN_2_GPIO_Port, EFUSE_DEN_2_Pin, GPIO_PIN_SET);
    ...
    HAL_GPIO_WritePin(EFUSE_DEN_3_GPIO_Port, EFUSE_DEN_3_Pin, GPIO_PIN_SET);
    ...
    HAL_GPIO_WritePin(EFUSE_DEN_4_GPIO_Port, EFUSE_DEN_4_Pin, GPIO_PIN_SET);
    ...
    HAL_GPIO_WritePin(EFUSE_DEN_5_GPIO_Port, EFUSE_DEN_5_Pin, GPIO_PIN_SET);
}
void GPIO_ConfigurePowerUp(volatile uint8_t *fault_states)
{
    ...
    HAL_GPIO_WritePin(EFUSE_DEN_1_GPIO_Port, EFUSE_DEN_1_Pin, GPIO_PIN_RESET);
    ...
    HAL_GPIO_WritePin(EFUSE_DEN_2_GPIO_Port, EFUSE_DEN_2_Pin, GPIO_PIN_RESET);
    ...
    HAL_GPIO_WritePin(
        EFUSE_ACC_ENC_FAN_IN_GPIO_Port, EFUSE_ACC_ENC_FAN_IN_Pin,
        GPIO_PIN_RESET);
    HAL_GPIO_WritePin(EFUSE_DEN_4_GPIO_Port, EFUSE_DEN_4_Pin, GPIO_PIN_RESET);
...
{
    HAL_GPIO_WritePin(EFUSE_DSEL_1_GPIO_Port, EFUSE_DSEL_1_Pin, dsel_value);
    HAL_GPIO_WritePin(EFUSE_DSEL_2_GPIO_Port, EFUSE_DSEL_2_Pin, dsel_value);
    HAL_GPIO_WritePin(EFUSE_DSEL_3_GPIO_Port, EFUSE_DSEL_3_Pin, dsel_value);
    HAL_GPIO_WritePin(EFUSE_DSEL_4_GPIO_Port, EFUSE_DSEL_4_Pin, dsel_value);
    HAL_GPIO_WritePin(EFUSE_DSEL_5_GPIO_Port, EFUSE_DSEL_5_Pin, dsel_value);
}
