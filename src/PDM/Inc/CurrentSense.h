...
static const float VOLTAGE_TO_CURRENT[ADC_CHANNEL_COUNT * NUM_CHANNELS] = {CURRENT_SCALING_AUX/SENSE_RESISTANCE, CURRENT_SCALING/SENSE_RESISTANCE, CURRENT_SCALING/SENSE_RESISTANCE,
											CURRENT_SCALING/SENSE_RESISTANCE, CURRENT_SCALING/SENSE_RESISTANCE, 0, 0, 0, CURRENT_SCALING_AUX/SENSE_RESISTANCE,
											CURRENT_SCALING/SENSE_RESISTANCE, CURRENT_SCALING/SENSE_RESISTANCE,
											CURRENT_SCALING/SENSE_RESISTANCE, CURRENT_SCALING/SENSE_RESISTANCE, 0, 0, 0};
...
static const uint8_t MAX_FAULTS[ADC_CHANNEL_COUNT * NUM_CHANNELS] = {3, 10, 3, 10, 3, 3, 3, 1, 3, 3, 3, 10, 3, 3, 3, 1};
