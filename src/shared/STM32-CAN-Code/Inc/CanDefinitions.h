...
#define BMS_CAN_TX_CAN_TX_FIFO_OVERFLOW_STDID                  (uint32_t)(0x02)
...
#define DCM_CAN_TX_CAN_TX_FIFO_OVERFLOW_STDID                  (uint32_t)(0x22)
...
#define FSM_CAN_TX_CAN_TX_FIFO_OVERFLOW_STDID                  (uint32_t)(0x42)
...
#define PDM_CAN_TX_CAN_TX_FIFO_OVERFLOW_STDID                  (uint32_t)(0x62)
...
#define BMS_CAN_TX_CAN_TX_FIFO_OVERFLOW_DLC                    (uint32_t)(8)
...
#define DCM_CAN_TX_CAN_TX_FIFO_OVERFLOW_DLC                    (uint32_t)(8)
...
#define FSM_CAN_TX_CAN_TX_FIFO_OVERFLOW_DLC                    (uint32_t)(8)
...
#define PDM_CAN_TX_CAN_TX_FIFO_OVERFLOW_DLC                    (uint32_t)(8)
