...
#define CANMSG_VC_WARNINGS_COUNTS_BYTES (8)
#define CANMSG_VC_FAULTS_COUNTS_BYTES (3)
...
#define CANMSG_FSM_WARNINGS_BYTES (3)
#define CANMSG_FSM_FAULTS_BYTES (1)
#define CANMSG_FSM_WARNINGS_COUNTS_BYTES (7)
#define CANMSG_FSM_FAULTS_COUNTS_BYTES (1)
...
#define CANMSG_VC_WARNINGS_COUNTS_CYCLE_TIME (1000)
#define CANMSG_VC_FAULTS_COUNTS_CYCLE_TIME (100)
...
#define CANMSG_FSM_WARNINGS_CYCLE_TIME (1000)
#define CANMSG_FSM_FAULTS_CYCLE_TIME (100)
#define CANMSG_FSM_WARNINGS_COUNTS_CYCLE_TIME (1000)
#define CANMSG_FSM_FAULTS_COUNTS_CYCLE_TIME (100)
...
// VC_WarningsCounts
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_WATCHDOG_TIMEOUT_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_TX_OVERFLOW_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_RX_OVERFLOW_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_REGEN_NOT_AVAILABLE_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_IMU_INIT_FAILED_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_FLOW_RATE_INPUT_OUT_OF_RANGE_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_BATTERY_RAIL_OVERCURRENT_FAULT_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_ACCUMULATOR_RAIL_OVERCURRENT_FAULT_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_LV_CHARGE_FAULT_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_BOOST_CONTROLLER_FAULT_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_HIGH_NUMBER_OF_CAN_DATA_LOGS_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_CAN_LOGGING_SD_CARD_NOT_PRESENT_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_CAN_LOGGING_ERRORED_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_BRAKE_APPS_DISAGREEMENT_COUNT_START_VAL (0)
#define CANSIG_VC_WARNING_SBG_INIT_FAILED_COUNT_START_VAL (0)

// VC_FaultsCounts
#define CANSIG_VC_FAULT_MISSING_BMS_HEARTBEAT_COUNT_START_VAL (0)
#define CANSIG_VC_FAULT_MISSING_FSM_HEARTBEAT_COUNT_START_VAL (0)
#define CANSIG_VC_FAULT_MISSING_RSM_HEARTBEAT_COUNT_START_VAL (0)
#define CANSIG_VC_FAULT_MISSING_CRIT_HEARTBEAT_COUNT_START_VAL (0)
#define CANSIG_VC_FAULT_LEFT_INVERTER_FAULT_COUNT_START_VAL (0)
#define CANSIG_VC_FAULT_RIGHT_INVERTER_FAULT_COUNT_START_VAL (0)
...
// FSM_Warnings
#define CANSIG_FSM_WARNING_WATCHDOG_TIMEOUT_START_VAL (0)
#define CANSIG_FSM_WARNING_TX_OVERFLOW_START_VAL (0)
#define CANSIG_FSM_WARNING_RX_OVERFLOW_START_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_START_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_START_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_START_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_START_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_START_VAL (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OCSC_START_VAL (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OUT_OF_RANGE_START_VAL (0)
#define CANSIG_FSM_WARNING_LEFT_WHEEL_SPEED_OUT_OF_RANGE_START_VAL (0)
#define CANSIG_FSM_WARNING_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_START_VAL (0)
#define CANSIG_FSM_WARNING_APPS_DISAGREEMENT_START_VAL (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OUT_OF_RANGE_START_VAL (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OUT_OF_RANGE_START_VAL (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OC_SC_START_VAL (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OC_SC_START_VAL (0)
#define CANSIG_FSM_WARNING_BRAKE_OC_SC_NOT_OK_START_VAL (0)

// FSM_Faults
#define CANSIG_FSM_FAULT_PAPPS_OCSC_START_VAL (0)
#define CANSIG_FSM_FAULT_SAPPS_OCSC_START_VAL (0)

// FSM_WarningsCounts
#define CANSIG_FSM_WARNING_WATCHDOG_TIMEOUT_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_TX_OVERFLOW_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_RX_OVERFLOW_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OCSC_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OUT_OF_RANGE_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_LEFT_WHEEL_SPEED_OUT_OF_RANGE_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_APPS_DISAGREEMENT_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OUT_OF_RANGE_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OUT_OF_RANGE_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OC_SC_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OC_SC_COUNT_START_VAL (0)
#define CANSIG_FSM_WARNING_BRAKE_OC_SC_NOT_OK_COUNT_START_VAL (0)

// FSM_FaultsCounts
#define CANSIG_FSM_FAULT_PAPPS_OCSC_COUNT_START_VAL (0)
#define CANSIG_FSM_FAULT_SAPPS_OCSC_COUNT_START_VAL (0)
...
// VC_WarningsCounts
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_WATCHDOG_TIMEOUT_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_WATCHDOG_TIMEOUT_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_TX_OVERFLOW_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_TX_OVERFLOW_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_RX_OVERFLOW_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_RX_OVERFLOW_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_REGEN_NOT_AVAILABLE_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_REGEN_NOT_AVAILABLE_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_IMU_INIT_FAILED_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_IMU_INIT_FAILED_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_FLOW_RATE_INPUT_OUT_OF_RANGE_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_FLOW_RATE_INPUT_OUT_OF_RANGE_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_BATTERY_RAIL_OVERCURRENT_FAULT_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_BATTERY_RAIL_OVERCURRENT_FAULT_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_ACCUMULATOR_RAIL_OVERCURRENT_FAULT_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_ACCUMULATOR_RAIL_OVERCURRENT_FAULT_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_LV_CHARGE_FAULT_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_LV_CHARGE_FAULT_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_BOOST_CONTROLLER_FAULT_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_BOOST_CONTROLLER_FAULT_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_HIGH_NUMBER_OF_CAN_DATA_LOGS_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_HIGH_NUMBER_OF_CAN_DATA_LOGS_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_CAN_LOGGING_SD_CARD_NOT_PRESENT_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_CAN_LOGGING_SD_CARD_NOT_PRESENT_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_CAN_LOGGING_ERRORED_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_CAN_LOGGING_ERRORED_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_BRAKE_APPS_DISAGREEMENT_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_BRAKE_APPS_DISAGREEMENT_COUNT_OFFSET (0)
#define CANSIG_VC_WARNING_SBG_INIT_FAILED_COUNT_SCALE (1)
#define CANSIG_VC_WARNING_SBG_INIT_FAILED_COUNT_OFFSET (0)

// VC_FaultsCounts
#define CANSIG_VC_FAULT_MISSING_BMS_HEARTBEAT_COUNT_SCALE (1)
#define CANSIG_VC_FAULT_MISSING_BMS_HEARTBEAT_COUNT_OFFSET (0)
#define CANSIG_VC_FAULT_MISSING_FSM_HEARTBEAT_COUNT_SCALE (1)
#define CANSIG_VC_FAULT_MISSING_FSM_HEARTBEAT_COUNT_OFFSET (0)
#define CANSIG_VC_FAULT_MISSING_RSM_HEARTBEAT_COUNT_SCALE (1)
#define CANSIG_VC_FAULT_MISSING_RSM_HEARTBEAT_COUNT_OFFSET (0)
#define CANSIG_VC_FAULT_MISSING_CRIT_HEARTBEAT_COUNT_SCALE (1)
#define CANSIG_VC_FAULT_MISSING_CRIT_HEARTBEAT_COUNT_OFFSET (0)
#define CANSIG_VC_FAULT_LEFT_INVERTER_FAULT_COUNT_SCALE (1)
#define CANSIG_VC_FAULT_LEFT_INVERTER_FAULT_COUNT_OFFSET (0)
#define CANSIG_VC_FAULT_RIGHT_INVERTER_FAULT_COUNT_SCALE (1)
#define CANSIG_VC_FAULT_RIGHT_INVERTER_FAULT_COUNT_OFFSET (0)
...
// FSM_Warnings
#define CANSIG_FSM_WARNING_WATCHDOG_TIMEOUT_SCALE (1)
#define CANSIG_FSM_WARNING_WATCHDOG_TIMEOUT_OFFSET (0)
#define CANSIG_FSM_WARNING_TX_OVERFLOW_SCALE (1)
#define CANSIG_FSM_WARNING_TX_OVERFLOW_OFFSET (0)
#define CANSIG_FSM_WARNING_RX_OVERFLOW_SCALE (1)
#define CANSIG_FSM_WARNING_RX_OVERFLOW_OFFSET (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_SCALE (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_OFFSET (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_SCALE (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_OFFSET (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_SCALE (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_OFFSET (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_SCALE (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_OFFSET (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_SCALE (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_OFFSET (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OCSC_SCALE (1)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OCSC_OFFSET (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OUT_OF_RANGE_SCALE (1)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OUT_OF_RANGE_OFFSET (0)
#define CANSIG_FSM_WARNING_LEFT_WHEEL_SPEED_OUT_OF_RANGE_SCALE (1)
#define CANSIG_FSM_WARNING_LEFT_WHEEL_SPEED_OUT_OF_RANGE_OFFSET (0)
#define CANSIG_FSM_WARNING_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_SCALE (1)
#define CANSIG_FSM_WARNING_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_OFFSET (0)
#define CANSIG_FSM_WARNING_APPS_DISAGREEMENT_SCALE (1)
#define CANSIG_FSM_WARNING_APPS_DISAGREEMENT_OFFSET (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OUT_OF_RANGE_SCALE (1)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OUT_OF_RANGE_OFFSET (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OUT_OF_RANGE_SCALE (1)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OUT_OF_RANGE_OFFSET (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OC_SC_SCALE (1)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OC_SC_OFFSET (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OC_SC_SCALE (1)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OC_SC_OFFSET (0)
#define CANSIG_FSM_WARNING_BRAKE_OC_SC_NOT_OK_SCALE (1)
#define CANSIG_FSM_WARNING_BRAKE_OC_SC_NOT_OK_OFFSET (0)

// FSM_Faults
#define CANSIG_FSM_FAULT_PAPPS_OCSC_SCALE (1)
#define CANSIG_FSM_FAULT_PAPPS_OCSC_OFFSET (0)
#define CANSIG_FSM_FAULT_SAPPS_OCSC_SCALE (1)
#define CANSIG_FSM_FAULT_SAPPS_OCSC_OFFSET (0)

// FSM_WarningsCounts
#define CANSIG_FSM_WARNING_WATCHDOG_TIMEOUT_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_WATCHDOG_TIMEOUT_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_TX_OVERFLOW_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_TX_OVERFLOW_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_RX_OVERFLOW_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_RX_OVERFLOW_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OCSC_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OCSC_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OUT_OF_RANGE_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OUT_OF_RANGE_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_LEFT_WHEEL_SPEED_OUT_OF_RANGE_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_LEFT_WHEEL_SPEED_OUT_OF_RANGE_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_APPS_DISAGREEMENT_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_APPS_DISAGREEMENT_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OUT_OF_RANGE_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OUT_OF_RANGE_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OUT_OF_RANGE_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OUT_OF_RANGE_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OC_SC_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OC_SC_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OC_SC_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OC_SC_COUNT_OFFSET (0)
#define CANSIG_FSM_WARNING_BRAKE_OC_SC_NOT_OK_COUNT_SCALE (1)
#define CANSIG_FSM_WARNING_BRAKE_OC_SC_NOT_OK_COUNT_OFFSET (0)

// FSM_FaultsCounts
#define CANSIG_FSM_FAULT_PAPPS_OCSC_COUNT_SCALE (1)
#define CANSIG_FSM_FAULT_PAPPS_OCSC_COUNT_OFFSET (0)
#define CANSIG_FSM_FAULT_SAPPS_OCSC_COUNT_SCALE (1)
#define CANSIG_FSM_FAULT_SAPPS_OCSC_COUNT_OFFSET (0)
...
// VC_WarningsCounts
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_WATCHDOG_TIMEOUT_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_WATCHDOG_TIMEOUT_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_TX_OVERFLOW_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_TX_OVERFLOW_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_RX_OVERFLOW_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_RX_OVERFLOW_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_REGEN_NOT_AVAILABLE_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_REGEN_NOT_AVAILABLE_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_IMU_INIT_FAILED_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_IMU_INIT_FAILED_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_FLOW_RATE_INPUT_OUT_OF_RANGE_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_FLOW_RATE_INPUT_OUT_OF_RANGE_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_BATTERY_RAIL_OVERCURRENT_FAULT_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_BATTERY_RAIL_OVERCURRENT_FAULT_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_ACCUMULATOR_RAIL_OVERCURRENT_FAULT_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_ACCUMULATOR_RAIL_OVERCURRENT_FAULT_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_LV_CHARGE_FAULT_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_LV_CHARGE_FAULT_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_BOOST_CONTROLLER_FAULT_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_BOOST_CONTROLLER_FAULT_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_HIGH_NUMBER_OF_CAN_DATA_LOGS_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_HIGH_NUMBER_OF_CAN_DATA_LOGS_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_CAN_LOGGING_SD_CARD_NOT_PRESENT_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_CAN_LOGGING_SD_CARD_NOT_PRESENT_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_CAN_LOGGING_ERRORED_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_CAN_LOGGING_ERRORED_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_BRAKE_APPS_DISAGREEMENT_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_BRAKE_APPS_DISAGREEMENT_COUNT_MAX_VAL (7)
#define CANSIG_VC_WARNING_SBG_INIT_FAILED_COUNT_MIN_VAL (0)
#define CANSIG_VC_WARNING_SBG_INIT_FAILED_COUNT_MAX_VAL (7)

// VC_FaultsCounts
#define CANSIG_VC_FAULT_MISSING_BMS_HEARTBEAT_COUNT_MIN_VAL (0)
#define CANSIG_VC_FAULT_MISSING_BMS_HEARTBEAT_COUNT_MAX_VAL (7)
#define CANSIG_VC_FAULT_MISSING_FSM_HEARTBEAT_COUNT_MIN_VAL (0)
#define CANSIG_VC_FAULT_MISSING_FSM_HEARTBEAT_COUNT_MAX_VAL (7)
#define CANSIG_VC_FAULT_MISSING_RSM_HEARTBEAT_COUNT_MIN_VAL (0)
#define CANSIG_VC_FAULT_MISSING_RSM_HEARTBEAT_COUNT_MAX_VAL (7)
#define CANSIG_VC_FAULT_MISSING_CRIT_HEARTBEAT_COUNT_MIN_VAL (0)
#define CANSIG_VC_FAULT_MISSING_CRIT_HEARTBEAT_COUNT_MAX_VAL (7)
#define CANSIG_VC_FAULT_LEFT_INVERTER_FAULT_COUNT_MIN_VAL (0)
#define CANSIG_VC_FAULT_LEFT_INVERTER_FAULT_COUNT_MAX_VAL (7)
#define CANSIG_VC_FAULT_RIGHT_INVERTER_FAULT_COUNT_MIN_VAL (0)
#define CANSIG_VC_FAULT_RIGHT_INVERTER_FAULT_COUNT_MAX_VAL (7)
...
// FSM_Warnings
#define CANSIG_FSM_WARNING_WATCHDOG_TIMEOUT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_WATCHDOG_TIMEOUT_MAX_VAL (1)
#define CANSIG_FSM_WARNING_TX_OVERFLOW_MIN_VAL (0)
#define CANSIG_FSM_WARNING_TX_OVERFLOW_MAX_VAL (1)
#define CANSIG_FSM_WARNING_RX_OVERFLOW_MIN_VAL (0)
#define CANSIG_FSM_WARNING_RX_OVERFLOW_MAX_VAL (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_MAX_VAL (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_MAX_VAL (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_MAX_VAL (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_MAX_VAL (1)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_MAX_VAL (1)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OCSC_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OCSC_MAX_VAL (1)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OUT_OF_RANGE_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OUT_OF_RANGE_MAX_VAL (1)
#define CANSIG_FSM_WARNING_LEFT_WHEEL_SPEED_OUT_OF_RANGE_MIN_VAL (0)
#define CANSIG_FSM_WARNING_LEFT_WHEEL_SPEED_OUT_OF_RANGE_MAX_VAL (1)
#define CANSIG_FSM_WARNING_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_MIN_VAL (0)
#define CANSIG_FSM_WARNING_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_MAX_VAL (1)
#define CANSIG_FSM_WARNING_APPS_DISAGREEMENT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_APPS_DISAGREEMENT_MAX_VAL (1)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OUT_OF_RANGE_MIN_VAL (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OUT_OF_RANGE_MAX_VAL (1)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OUT_OF_RANGE_MIN_VAL (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OUT_OF_RANGE_MAX_VAL (1)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OC_SC_MIN_VAL (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OC_SC_MAX_VAL (1)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OC_SC_MIN_VAL (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OC_SC_MAX_VAL (1)
#define CANSIG_FSM_WARNING_BRAKE_OC_SC_NOT_OK_MIN_VAL (0)
#define CANSIG_FSM_WARNING_BRAKE_OC_SC_NOT_OK_MAX_VAL (1)

// FSM_Faults
#define CANSIG_FSM_FAULT_PAPPS_OCSC_MIN_VAL (0)
#define CANSIG_FSM_FAULT_PAPPS_OCSC_MAX_VAL (1)
#define CANSIG_FSM_FAULT_SAPPS_OCSC_MIN_VAL (0)
#define CANSIG_FSM_FAULT_SAPPS_OCSC_MAX_VAL (1)

// FSM_WarningsCounts
#define CANSIG_FSM_WARNING_WATCHDOG_TIMEOUT_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_WATCHDOG_TIMEOUT_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_TX_OVERFLOW_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_TX_OVERFLOW_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_RX_OVERFLOW_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_RX_OVERFLOW_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OCSC_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OCSC_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OUT_OF_RANGE_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_STEERING_ANGLE_OUT_OF_RANGE_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_LEFT_WHEEL_SPEED_OUT_OF_RANGE_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_LEFT_WHEEL_SPEED_OUT_OF_RANGE_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_RIGHT_WHEEL_SPEED_OUT_OF_RANGE_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_APPS_DISAGREEMENT_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_APPS_DISAGREEMENT_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OUT_OF_RANGE_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OUT_OF_RANGE_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OUT_OF_RANGE_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OUT_OF_RANGE_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OC_SC_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_FRONT_BRAKE_PRESSURE_OC_SC_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OC_SC_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_REAR_BRAKE_PRESSURE_OC_SC_COUNT_MAX_VAL (7)
#define CANSIG_FSM_WARNING_BRAKE_OC_SC_NOT_OK_COUNT_MIN_VAL (0)
#define CANSIG_FSM_WARNING_BRAKE_OC_SC_NOT_OK_COUNT_MAX_VAL (7)

// FSM_FaultsCounts
#define CANSIG_FSM_FAULT_PAPPS_OCSC_COUNT_MIN_VAL (0)
#define CANSIG_FSM_FAULT_PAPPS_OCSC_COUNT_MAX_VAL (7)
#define CANSIG_FSM_FAULT_SAPPS_OCSC_COUNT_MIN_VAL (0)
#define CANSIG_FSM_FAULT_SAPPS_OCSC_COUNT_MAX_VAL (7)
...
typedef struct
{
    ...
    bool FSM_Warning_RearBrakePressureOutOfRange_value;
    bool FSM_Warning_FrontBrakePressureOcSc_value;
    bool FSM_Warning_RearBrakePressureOcSc_value;
    bool FSM_Warning_BrakeOcScNotOk_value;
...
typedef struct
{
    ...
    bool FSM_Fault_SappsOCSC_value;
...
typedef struct
{
    ...
    uint32_t FSM_Warning_RearBrakePressureOutOfRangeCount_value;
    uint32_t FSM_Warning_FrontBrakePressureOcScCount_value;
    uint32_t FSM_Warning_RearBrakePressureOcScCount_value;
    uint32_t FSM_Warning_BrakeOcScNotOkCount_value;
...
typedef struct
{
    ...
    uint32_t FSM_Fault_SappsOCSCCount_value;
