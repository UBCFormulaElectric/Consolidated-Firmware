...
void app_canRx_init()
{
    ...
    app_canRx_VC_Vitals_VC_Heartbeat_update(CANSIG_VC_HEARTBEAT_START_VAL);
    app_canRx_VC_Vitals_VC_State_update(CANSIG_VC_STATE_START_VAL);
    app_canRx_VC_Vitals_VC_BuzzerOn_update(CANSIG_VC_BUZZER_ON_START_VAL);
    app_canRx_VC_Vitals_VC_NumberOfCanDataLogs_update(CANSIG_VC_NUMBER_OF_CAN_DATA_LOGS_START_VAL);
    app_canRx_VC_Vitals_VC_CanLoggingRemainingErrors_update(CANSIG_VC_CAN_LOGGING_REMAINING_ERRORS_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_StackWaterMarkHighTask1Hz_update(CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1_HZ_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_StackWaterMarkHighTask100Hz_update(CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK100_HZ_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_StackWaterMarkHighTask1kHz_update(CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK1K_HZ_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_StackWaterMarkHighTaskCanRx_update(CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_RX_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_StackWaterMarkHighTaskCanTx_update(CANSIG_VC_WARNING_STACK_WATER_MARK_HIGH_TASK_CAN_TX_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_WatchdogTimeout_update(CANSIG_VC_WARNING_WATCHDOG_TIMEOUT_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_TxOverflow_update(CANSIG_VC_WARNING_TX_OVERFLOW_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_RxOverflow_update(CANSIG_VC_WARNING_RX_OVERFLOW_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_RegenNotAvailable_update(CANSIG_VC_WARNING_REGEN_NOT_AVAILABLE_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_ImuInitFailed_update(CANSIG_VC_WARNING_IMU_INIT_FAILED_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_FlowRateInputOutOfRange_update(CANSIG_VC_WARNING_FLOW_RATE_INPUT_OUT_OF_RANGE_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_BatteryRailOvercurrentFault_update(CANSIG_VC_WARNING_BATTERY_RAIL_OVERCURRENT_FAULT_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_AccumulatorRailOvercurrentFault_update(CANSIG_VC_WARNING_ACCUMULATOR_RAIL_OVERCURRENT_FAULT_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_LvChargeFault_update(CANSIG_VC_WARNING_LV_CHARGE_FAULT_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_BoostControllerFault_update(CANSIG_VC_WARNING_BOOST_CONTROLLER_FAULT_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_HighNumberOfCanDataLogs_update(CANSIG_VC_WARNING_HIGH_NUMBER_OF_CAN_DATA_LOGS_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_CanLoggingSdCardNotPresent_update(CANSIG_VC_WARNING_CAN_LOGGING_SD_CARD_NOT_PRESENT_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_CanLoggingErrored_update(CANSIG_VC_WARNING_CAN_LOGGING_ERRORED_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_BrakeAppsDisagreement_update(CANSIG_VC_WARNING_BRAKE_APPS_DISAGREEMENT_START_VAL);
    app_canRx_VC_Warnings_VC_Warning_SbgInitFailed_update(CANSIG_VC_WARNING_SBG_INIT_FAILED_START_VAL);
    app_canRx_VC_Faults_VC_Fault_MissingBMSHeartbeat_update(CANSIG_VC_FAULT_MISSING_BMS_HEARTBEAT_START_VAL);
    app_canRx_VC_Faults_VC_Fault_MissingFSMHeartbeat_update(CANSIG_VC_FAULT_MISSING_FSM_HEARTBEAT_START_VAL);
    app_canRx_VC_Faults_VC_Fault_MissingRSMHeartbeat_update(CANSIG_VC_FAULT_MISSING_RSM_HEARTBEAT_START_VAL);
    app_canRx_VC_Faults_VC_Fault_MissingCRITHeartbeat_update(CANSIG_VC_FAULT_MISSING_CRIT_HEARTBEAT_START_VAL);
    app_canRx_VC_Faults_VC_Fault_LeftInverterFault_update(CANSIG_VC_FAULT_LEFT_INVERTER_FAULT_START_VAL);
    app_canRx_VC_Faults_VC_Fault_RightInverterFault_update(CANSIG_VC_FAULT_RIGHT_INVERTER_FAULT_START_VAL);
