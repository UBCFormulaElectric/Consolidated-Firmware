...
/**
 * Get value stored in RX table of signal VC_Warning_StackWaterMarkHighTask1Hz in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_StackWaterMarkHighTask1Hz_get(void);/**
 * Get value stored in RX table of signal VC_Warning_StackWaterMarkHighTask100Hz in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_StackWaterMarkHighTask100Hz_get(void);/**
 * Get value stored in RX table of signal VC_Warning_StackWaterMarkHighTask1kHz in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_StackWaterMarkHighTask1kHz_get(void);/**
 * Get value stored in RX table of signal VC_Warning_StackWaterMarkHighTaskCanRx in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_StackWaterMarkHighTaskCanRx_get(void);/**
 * Get value stored in RX table of signal VC_Warning_StackWaterMarkHighTaskCanTx in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_StackWaterMarkHighTaskCanTx_get(void);/**
 * Get value stored in RX table of signal VC_Warning_WatchdogTimeout in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_WatchdogTimeout_get(void);/**
 * Get value stored in RX table of signal VC_Warning_TxOverflow in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_TxOverflow_get(void);/**
 * Get value stored in RX table of signal VC_Warning_RxOverflow in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_RxOverflow_get(void);/**
 * Get value stored in RX table of signal VC_Warning_RegenNotAvailable in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_RegenNotAvailable_get(void);/**
 * Get value stored in RX table of signal VC_Warning_ImuInitFailed in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_ImuInitFailed_get(void);/**
 * Get value stored in RX table of signal VC_Warning_FlowRateInputOutOfRange in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_FlowRateInputOutOfRange_get(void);/**
 * Get value stored in RX table of signal VC_Warning_BatteryRailOvercurrentFault in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_BatteryRailOvercurrentFault_get(void);/**
 * Get value stored in RX table of signal VC_Warning_AccumulatorRailOvercurrentFault in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_AccumulatorRailOvercurrentFault_get(void);/**
 * Get value stored in RX table of signal VC_Warning_LvChargeFault in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_LvChargeFault_get(void);/**
 * Get value stored in RX table of signal VC_Warning_BoostControllerFault in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_BoostControllerFault_get(void);/**
 * Get value stored in RX table of signal VC_Warning_HighNumberOfCanDataLogs in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_HighNumberOfCanDataLogs_get(void);/**
 * Get value stored in RX table of signal VC_Warning_CanLoggingSdCardNotPresent in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_CanLoggingSdCardNotPresent_get(void);/**
 * Get value stored in RX table of signal VC_Warning_CanLoggingErrored in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_CanLoggingErrored_get(void);/**
 * Get value stored in RX table of signal VC_Warning_BrakeAppsDisagreement in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_BrakeAppsDisagreement_get(void);/**
 * Get value stored in RX table of signal VC_Warning_SbgInitFailed in msg VC_Warnings.
 */
bool app_canRx_VC_Warning_SbgInitFailed_get(void);
/**
 * Get value stored in RX table of signal VC_Fault_MissingBMSHeartbeat in msg VC_Faults.
 */
bool app_canRx_VC_Fault_MissingBMSHeartbeat_get(void);/**
 * Get value stored in RX table of signal VC_Fault_MissingFSMHeartbeat in msg VC_Faults.
 */
bool app_canRx_VC_Fault_MissingFSMHeartbeat_get(void);/**
 * Get value stored in RX table of signal VC_Fault_MissingRSMHeartbeat in msg VC_Faults.
 */
bool app_canRx_VC_Fault_MissingRSMHeartbeat_get(void);/**
 * Get value stored in RX table of signal VC_Fault_MissingCRITHeartbeat in msg VC_Faults.
 */
bool app_canRx_VC_Fault_MissingCRITHeartbeat_get(void);/**
 * Get value stored in RX table of signal VC_Fault_LeftInverterFault in msg VC_Faults.
 */
bool app_canRx_VC_Fault_LeftInverterFault_get(void);/**
 * Get value stored in RX table of signal VC_Fault_RightInverterFault in msg VC_Faults.
 */
bool app_canRx_VC_Fault_RightInverterFault_get(void);
