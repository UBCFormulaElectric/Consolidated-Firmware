...
/* Private defines -----------------------------------------------------------*/
#define nTSIM_GRN_EN_Pin GPIO_PIN_2
#define nTSIM_GRN_EN_GPIO_Port GPIOE
#define TSIM_RED_EN_Pin GPIO_PIN_3
#define TSIM_RED_EN_GPIO_Port GPIOE
#define BUZZER_PWR_EN_Pin GPIO_PIN_2
#define BUZZER_PWR_EN_GPIO_Port GPIOA
#define TELEM_PWR_EN_Pin GPIO_PIN_3
#define TELEM_PWR_EN_GPIO_Port GPIOA
#define SD_FAIL_Pin GPIO_PIN_1
#define SD_FAIL_GPIO_Port GPIOB
...
#define FROM_900M_RX_GPIO_Port GPIOD
