...
static TorqueAllocationInputs torqueAllocation = { .yaw_moment     = 0.0f,
                                                   .load_transfer_const  = 1.0f,
...
void app_torqueVectoring_run(const float accelerator_pedal_percentage, TorqueAllocationOutputs *torqueOutputToMotors)
{
    ...
    // {
    //     app_torqueVectoring_handleAcceleration(torqueOutputToMotors);
    // }
    ...
    app_torqueAllocation(&torqueAllocation, torqueOutputToMotors);
    // app_torqueBroadCast(&torqueOutputToMotors);
}
// Read data from CAN
// void app_torqueVectoring_handleAcceleration(TorqueAllocationOutputs *torqueOutputToMotors)
// {
//     // Power Limiting
//     // Power limit correction
//     // float power_limit      = app_powerLimiting_computeMaxPower(RULES_BASED_POWER_LIMIT_KW); // -- HARD CODED FIX
