...
const ST_LoadSwitch inv_rsm_loadswitch = {.efuse1 = &f_inv_efuse, .efuse2 = &rsm_efuse, .stby_reset_gpio = &fr_stby_inv};
const ST_LoadSwitch inv_bms_loadswitch = {.efuse1 = &bms_efuse, .efuse2 = &r_inv_efuse, .stby_reset_gpio = &fr_stby_front};
const ST_LoadSwitch front_loadswitch = {.efuse1 = &dam_efuse, .efuse2 = &front_efuse, .stby_reset_gpio = &fr_stby_rear};
...
const ST_LoadSwitch rad_fan_loadswitch = {.efuse1 = &l_rad_fan_efuse, .efuse2 = &r_rad_fan_efuse, .stby_reset_gpio = &fr_stby_rad};
