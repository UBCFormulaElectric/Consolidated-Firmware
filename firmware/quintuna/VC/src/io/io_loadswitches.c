...
static const Efuse f_inv_efuse     = { .enable_gpio = &f_inv_en, .sns_adc_channel = &inv_f_pwr_v_sns };
static const Efuse rsm_efuse       = { .enable_gpio = &rsm_en, .sns_adc_channel = &rsm_v_sns };
static const Efuse bms_efuse       = { .enable_gpio = &bms_en, .sns_adc_channel = &bms_v_sns };
static const Efuse r_inv_efuse     = { .enable_gpio = &r_inv_en, .sns_adc_channel = &inv_r_pwr_v_sns };
static const Efuse rr_pump_efuse   = { .enable_gpio = &rr_pump_en, .sns_adc_channel = &pump_rr_pwr_v_sns };
static const Efuse f_pump_efuse    = { .enable_gpio = &f_pump_en, .sns_adc_channel = &pump_f_pwr_v_sns };
static const Efuse dam_efuse       = { .enable_gpio = &dam_en, .sns_adc_channel = &dam_v_sns };
static const Efuse front_efuse     = { .enable_gpio = &front_en, .sns_adc_channel = &front_v_sns };
static const Efuse rl_pump_efuse   = { .enable_gpio = &rl_pump_en, .sns_adc_channel = &pump_rl_pwr_v_sns };
static const Efuse r_rad_fan_efuse = { .enable_gpio = &rr_rad_fan_en, .sns_adc_channel = &r_rad_fan_v_sns };
...
const Efuse *const efuse_channels[NUM_EFUSE_CHANNELS] = {
    ...
    [EFUSE_CHANNEL_F_PUMP] = &f_pump_efuse,   [EFUSE_CHANNEL_R_RAD] = &r_rad_fan_efuse
};
z`