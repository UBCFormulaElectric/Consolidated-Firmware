...
static Efuse f_inv_efuse = { .enable_gpio = &f_inv_en, .sns_adc_channel = &inv_f_pwr_i_sns, .st = &f_inv_st_efuse };
static Efuse rsm_efuse   = { .enable_gpio = &rsm_en, .sns_adc_channel = &rsm_i_sns, .st = &f_inv_st_efuse };
static Efuse bms_efuse   = { .enable_gpio = &bms_en, .sns_adc_channel = &bms_i_sns, .st = &bms_st_efuse };
static Efuse r_inv_efuse = { .enable_gpio = &r_inv_en, .sns_adc_channel = &inv_r_pwr_i_sns, .st = &r_inv_st_efuse };
static Efuse dam_efuse   = { .enable_gpio = &dam_en, .sns_adc_channel = &dam_i_sns, .st = &dam_st_efuse };

static Efuse front_efuse = { .enable_gpio = &front_en, .sns_adc_channel = &front_i_sns, .st = &front_st_efuse };
