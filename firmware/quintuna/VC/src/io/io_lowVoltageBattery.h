...
namespace io::lowVoltageBattery
{
class LowVoltageBattery
{
    const Gpio *lt3650_charger_fault;
    const Gpio *ltc3786_boost_fault;
    const Adc  *vbat_vsense;
    const Adc  *boost_vsense;
    const Adc  *acc_vsense;

    explicit LowVoltageBattery(
        const Gpio *lt3650_charger_fault_in,
        const Gpio *ltc3786_boost_fault_in,
        const Adc  *vbat_vsense_in,
        const Adc  *boost_vsense_in,
        const Adc  *acc_vsense_in)
      : lt3650_charger_fault(lt3650_charger_fault_in),
        ltc3786_boost_fault(ltc3786_boost_fault_in),
        vbat_vsense(vbat_vsense_in),
        boost_vsense(boost_vsense_in),
        acc_vsense(acc_vsense_in)
    {
    }
};
} // namespace io::lowVoltageBattery
