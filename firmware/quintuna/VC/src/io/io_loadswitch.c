...
const LoadSwitch rear_pumps_loadswitch = {
    .efuse1 = &pump_rl_pwr_switch,
    .efuse2 = &pump_rr_pwr_switch,
    .stby_reset_gpio = &fr_stby_rear_pump 
};
const LoadSwitch front_pump_loadswitch = {
    .efuse1 = &pump_f_pwr_switch,
    .efuse2 = &extra_switch,
    .stby_reset_gpio = &fr_stby_f_pump
};
const LoadSwitch rad_fan_loadswitch = {
    .efuse1 = &l_rad_fan_switch,
    .efuse2 = &r_rad_fan_switch,
    .stby_reset_gpio = &fr_stby_rad
};
const LoadSwitch front_loadswitch = {
    .efuse1 = &bms_en_switch,
    .efuse2 = &front_en_switch,
    .stby_reset_gpio = &fr_stby_front
};
const LoadSwitch rear_loadswitch = {
    .efuse1 = &rsm_en_switch,
