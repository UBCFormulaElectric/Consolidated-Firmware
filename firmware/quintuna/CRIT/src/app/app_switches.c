...
void app_switches_broadcast(void)
{
    ...
    const bool torquevec_switch_on = io_switch_isClosed(&vanilla_override_switch);
    app_canTx_CRIT_VanillaOverrideSwitch_set(torquevec_switch_on ? SWITCH_ON : SWITCH_OFF);
