...
static StaticTask<512, osPriorityBelowNormal, "TaskCanRx"> TaskCanRx{ "TaskCanRx", osPriorityBelowNormal, tasks_runCanRx };
static StaticTask<512, osPriorityBelowNormal, "TaskCanTx"> TaskCanTx{ "TaskCanTx", osPriorityBelowNormal, tasks_runCanTx };
...
static StaticTask<512, osPriorityNormal, "TaskLtcVoltages"> TaskLtcVoltages{ "TaskLtcVoltages", osPriorityNormal, tasks_runLtcVoltages };
