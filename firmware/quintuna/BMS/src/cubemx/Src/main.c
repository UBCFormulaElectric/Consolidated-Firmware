...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(
        GPIOE,
        IR_P_EN_Pin | SHDN_EN_Pin | PRE_CHARGE_EN_Pin | FB_STBY_SHDN_Pin | FAN_EN_Pin | BMS_OK_Pin |
    ...
    GPIO_InitStruct.Pin  = BMS_LATCH_Pin | IMD_OK_Pin | BSPD_LATCH_Pin | FAN_PGOOD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
    ...
    /*Configure GPIO pin : nEVSE_I_LIM_GPIO_Pin */
    GPIO_InitStruct.Pin   = nEVSE_I_LIM_GPIO_Pin;
    GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_OD;
    GPIO_InitStruct.Pull  = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(nEVSE_I_LIM_GPIO_GPIO_Port, &GPIO_InitStruct);
