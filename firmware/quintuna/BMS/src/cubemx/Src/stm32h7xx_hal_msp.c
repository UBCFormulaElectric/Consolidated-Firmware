...
void HAL_ADC_MspInit(ADC_HandleTypeDef *hadc)
{
    ...
    if (hadc->Instance == ADC1)
    {
        ...
        */
        GPIO_InitStruct.Pin =
            EMETER_THERM_SNS_Pin | SHDN_ISNS_Pin | TS_ISENSE_400A_Pin | TS_ISENSE_50A_Pin | FAN_ISNS_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef *hadc)
{
    if (hadc->Instance == ADC1)
    {
        ...
        */
        HAL_GPIO_DeInit(
            GPIOA, EMETER_THERM_SNS_Pin | SHDN_ISNS_Pin | TS_ISENSE_400A_Pin | TS_ISENSE_50A_Pin | FAN_ISNS_Pin);
