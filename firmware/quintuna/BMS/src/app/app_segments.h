...
#define MAX_CELL_TEMP_WARNING_V (59)
...
#define OVER_VOLTAGE_DEBOUNCE_FAULT_MS (10000)
#define UNDER_VOLTAGE_DEBOUNCE_FAULT_MS (10000)
#define OVER_TEMP_DEBOUNCE_FAULT_MS (10000)
#define COMM_ERR_DEBOUNCE_FAULT_MS (10000)
