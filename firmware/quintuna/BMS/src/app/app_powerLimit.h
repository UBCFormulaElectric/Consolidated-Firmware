 ...
 */
float app_powerLimit_calcLowVoltageCurrentLimit(); // TODO: implement this once app SOC is merged with master -
 ...
 */
float app_powerLimit_calcHighVoltageClampCurrentLimit(); // TODO: implement this once app SOC is merged with
 ...
 */
float app_powerLimit_calcLowSOCCurrentLimit(); // TODO: implement this - see quadrina current limit pr

/**
 * @brief Gets the High SOC based charge current limit
 * @return High SOC based charge current Limit value
 */
float app_powerLimit_calcHighSOCCurrentLimit(); // TODO: implement this - see quadrina current limit pr
