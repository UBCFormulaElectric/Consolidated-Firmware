...
{
    const IRsState negative_closed  = io_irs_negativeState();
    const IRsState positive_closed  = io_irs_positiveState();
    const IRsState precharge_closed = io_irs_prechargeState();
