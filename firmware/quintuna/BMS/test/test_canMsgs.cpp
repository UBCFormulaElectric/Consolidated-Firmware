...
{
    ASSERT_GE(HZ_TO_MS(10), CAN_MSG_BMS_LATCH_STATUS_CYCLE_TIME_MS);
}
...
{
    ASSERT_GE(HZ_TO_MS(1), CAN_MSG_BMS_CELL_TEMP_STATS_CYCLE_TIME_MS);
}
...
{
    ASSERT_GE(HZ_TO_MS(1), CAN_MSG_BMS_TRACTIVE_SYSTEM_CYCLE_TIME_MS);
}
