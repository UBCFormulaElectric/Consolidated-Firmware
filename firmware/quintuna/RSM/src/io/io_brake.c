...
#define BRAKE_ACTUATED_THRESHOLD_PSI (8.0f)   // Minimum pressure (in Psi) to consider the brake actuated
...
#define BRAKE_PSI_PER_VOLT (100.0f / (BRAKE_PRESSURE_SC_THRESHOLD_V - BRAKE_PRESSURE_OC_THRESHOLD_V))
...
// OCSC pin not connected to harness
//
