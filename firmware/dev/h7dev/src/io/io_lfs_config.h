...
#define IO_LFS_READ_SIZE IO_LFS_BLOCK_SIZE *IO_LFS_READ_SIZE_FACTOR
#define IO_LFS_PROG_SIZE IO_LFS_BLOCK_SIZE *IO_LFS_PROG_SIZE_FACTOR
#define IO_LFS_LOOKAHEAD_SIZE IO_LFS_BLOCK_SIZE *IO_LFS_LOOKAHEAD_SIZE_FACTOR
#define IO_LFS_CACHE_SIZE IO_LFS_BLOCK_SIZE *IO_LFS_CACHE_SIZE_FACTOR
