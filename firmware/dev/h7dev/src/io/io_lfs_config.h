...
#define LFS_NO_MALLOC 1// no malloc option

// those factor will be multiple with the block size
#define IO_LFS_BLOCK_SIZE_FACTOR 4
#define IO_LFS_READ_SIZE_FACTOR 4
#define IO_LFS_PROG_SIZE_FACTOR 4
#define IO_LFS_LOOKAHEAD_SIZE_FACTOR 4
