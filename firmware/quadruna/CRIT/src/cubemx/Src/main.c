...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, SHDN_G_Pin|VC_G_Pin|RSM_G_Pin|RSM_R_Pin
                          |FSM_B_Pin|FSM_G_Pin|IMD_R_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, SHDN_R_Pin|BMS_B_Pin|BMS_G_Pin|BSPD_R_Pin
                          |BMS_R_Pin|FSM_R_Pin|VC_B_Pin|LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, VC_R_Pin|AUX_DB_B_Pin|AUX_DB_G_Pin|AUX_DB_R_Pin
                          |CRIT_DB_B_Pin|CRIT_DB_G_Pin|CRIT_DB_R_Pin|RSM_B_Pin
                          |START_LED_Pin|TORQUE_VECTORING_LED_Pin|REGEN_LED_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = SHDN_G_Pin|VC_G_Pin|RSM_G_Pin|RSM_R_Pin
                          |FSM_B_Pin|FSM_G_Pin|IMD_R_Pin;
  ...
  GPIO_InitStruct.Pin = SHDN_R_Pin|BMS_B_Pin|BMS_G_Pin|BSPD_R_Pin
                          |BMS_R_Pin|FSM_R_Pin|VC_B_Pin|LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = VC_R_Pin|AUX_DB_B_Pin|AUX_DB_G_Pin|AUX_DB_R_Pin
                          |CRIT_DB_B_Pin|CRIT_DB_G_Pin|CRIT_DB_R_Pin|RSM_B_Pin
                          |START_LED_Pin|TORQUE_VECTORING_LED_Pin|REGEN_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : START_SIG_Pin REGEN_SIG_Pin TORQUE_VECTORING_SIG_Pin */
  GPIO_InitStruct.Pin = START_SIG_Pin|REGEN_SIG_Pin|TORQUE_VECTORING_SIG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
