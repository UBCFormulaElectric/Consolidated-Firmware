...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, INV_R_PWR_EN_Pin|INV_R_PROGRAM_Pin|INV_L_PROGRAM_Pin|SHDN_PWR_EN_Pin
                          |INV_L_PWR_EN_Pin|FR_STBY3_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = INV_R_PWR_EN_Pin|INV_R_PROGRAM_Pin|INV_L_PROGRAM_Pin|SHDN_PWR_EN_Pin
                          |INV_L_PWR_EN_Pin|FR_STBY3_Pin;
