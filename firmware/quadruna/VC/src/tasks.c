...
void (*const heartbeatFaultSetters[HEARTBEAT_BOARD_COUNT])(bool) = {
    ...
    [DIM_HEARTBEAT_BOARD]  = NULL,
    [CRIT_HEARTBEAT_BOARD] = app_canAlerts_CRIT_Fault_MissingFSMHeartbeat_set
};
...
bool (*const heartbeatFaultGetters[HEARTBEAT_BOARD_COUNT])(void) = {
    ...
    [DIM_HEARTBEAT_BOARD]  = NULL,
    [CRIT_HEARTBEAT_BOARD] = app_canAlerts_CRIT_Fault_MissingFSMHeartbeat_get
};
