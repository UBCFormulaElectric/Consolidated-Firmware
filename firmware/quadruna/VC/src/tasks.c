...
void canTxQueueOverflowClearCallback(void)
{
    ...
    static const LvBatteryConfig lv_battery_config = { .lt3650_charger_fault_gpio = nchrg_fault,
                                                       ...
                                                       .acc_vsense_adc_channel =
                                                           id_to_adc[VC_AdcNetName__24V_ACC_SENSE] };
    ...
    void (*const heartbeatUpdaters[HEARTBEAT_BOARD_COUNT])(
    ...
    void (*const heartbeatFaultSetters[HEARTBEAT_BOARD_COUNT])(
        bool) = { [BMS_HEARTBEAT_BOARD]  = app_canAlerts_VC_Fault_MissingBMSHeartbeat_set,
                  [VC_HEARTBEAT_BOARD]   = NULL,
    ...
    bool (*const heartbeatFaultGetters[HEARTBEAT_BOARD_COUNT])(
        void) = { [BMS_HEARTBEAT_BOARD]  = app_canAlerts_VC_Fault_MissingBMSHeartbeat_get,
                  [VC_HEARTBEAT_BOARD]   = NULL,
