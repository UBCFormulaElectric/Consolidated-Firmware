...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, BMS_B_Pin|BMS_G_Pin|BSPD_R_Pin|BMS_R_Pin
                          |FMS_R_Pin|VC_B_Pin|LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, VC_G_Pin|RSM_G_Pin|RSM_R_Pin|FSM_B_Pin
                          |FSM_G_Pin|IMD_R_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_WritePin(GPIOB, VC_R_Pin|AUX_DB_B_Pin|AUX_DB_G_Pin|AUX_DB_R_Pin
                          ...
                          |TORQUE_VECTORING_SIG_Pin|START_LED_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = DRIVE_MODE_1B_Pin|NCHIMERA_Pin|DRIVE_MODE_0B_Pin|DRIVE_MODE_3B_Pin
                          |DRIVE_MODE_2B_Pin|SHDN_G_Pin|INERTIA_SEN_Pin|SHDN_SEN_Pin;
  ...
  GPIO_InitStruct.Pin = BMS_B_Pin|BMS_G_Pin|BSPD_R_Pin|BMS_R_Pin
                          |FMS_R_Pin|VC_B_Pin|LED_Pin;
  ...
  /*Configure GPIO pins : VC_G_Pin RSM_G_Pin RSM_R_Pin FSM_B_Pin
                           FSM_G_Pin IMD_R_Pin */
  GPIO_InitStruct.Pin = VC_G_Pin|RSM_G_Pin|RSM_R_Pin|FSM_B_Pin
                          |FSM_G_Pin|IMD_R_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
