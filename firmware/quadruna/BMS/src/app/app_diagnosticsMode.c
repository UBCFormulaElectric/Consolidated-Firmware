...
void (*cellVoltageSetters[ACCUMULATOR_NUM_SEGMENTS][ACCUMULATOR_NUM_SERIES_CELLS_PER_SEGMENT])(float) = {
    { app_canTx_BMS_Seg0_Cell0_Voltage_set, app_canTx_BMS_Seg0_Cell1_Voltage_set, app_canTx_BMS_Seg0_Cell2_Voltage_set,
      ...
      app_canTx_BMS_Seg0_Cell13_Voltage_set, app_canTx_BMS_Seg0_Cell14_Voltage_set,
    ...
    // { app_canTx_BMS_Seg4_Cell0_Voltage_set, app_canTx_BMS_Seg4_Cell1_Voltage_set, 
    // app_canTx_BMS_Seg4_Cell2_Voltage_set,
    //   app_canTx_BMS_Seg4_Cell3_Voltage_set, app_canTx_BMS_Seg4_Cell4_Voltage_set, 
    //   app_canTx_BMS_Seg4_Cell5_Voltage_set, app_canTx_BMS_Seg4_Cell6_Voltage_set, 
    //   app_canTx_BMS_Seg4_Cell7_Voltage_set, app_canTx_BMS_Seg4_Cell8_Voltage_set,
