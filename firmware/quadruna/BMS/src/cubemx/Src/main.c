...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, BMS_OK_3V3_Pin|AUX_TSENSE_MUX0_Pin|AUX_TSENSE_MUX1_Pin|AUX_TSENSE_MUX2_Pin
                          |AUX_TSENSE_MUX3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : HVD_SHDN_OK_Pin TS_ILCK_SHDN_OK_Pin nHIGH_CURRENT_BSPD_3V3_Pin nCHIMERA_Pin
                           IMD_OK_3V3_Pin */
  GPIO_InitStruct.Pin = HVD_SHDN_OK_Pin|TS_ILCK_SHDN_OK_Pin|nHIGH_CURRENT_BSPD_3V3_Pin|nCHIMERA_Pin
                          |IMD_OK_3V3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : BMS_OK_3V3_Pin AUX_TSENSE_MUX0_Pin AUX_TSENSE_MUX1_Pin AUX_TSENSE_MUX2_Pin
                           AUX_TSENSE_MUX3_Pin */
  GPIO_InitStruct.Pin = BMS_OK_3V3_Pin|AUX_TSENSE_MUX0_Pin|AUX_TSENSE_MUX1_Pin|AUX_TSENSE_MUX2_Pin
                          |AUX_TSENSE_MUX3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : BSPD_OK_3V3_Pin BSPD_LATCH_Pin IMD_LATCH_Pin BMS_LATCH_Pin */
  GPIO_InitStruct.Pin = BSPD_OK_3V3_Pin|BSPD_LATCH_Pin|IMD_LATCH_Pin|BMS_LATCH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
