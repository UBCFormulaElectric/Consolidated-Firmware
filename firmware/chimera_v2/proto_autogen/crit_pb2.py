...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GPIONETNAME']._serialized_end = 309
    _globals['_ADCNETNAME']._serialized_start = 311
    _globals['_ADCNETNAME']._serialized_end = 353
    _globals['_I2CNETNAME']._serialized_start = 355
    _globals['_I2CNETNAME']._serialized_end = 397
    _globals['_SPINETNAME']._serialized_start = 399
    _globals['_SPINETNAME']._serialized_end = 473
    _globals['_PWMOUTPUTNETNAME']._serialized_start = 475
    _globals['_PWMOUTPUTNETNAME']._serialized_end = 592