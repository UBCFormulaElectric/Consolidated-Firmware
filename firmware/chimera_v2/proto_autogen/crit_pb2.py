...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SPINETNAME']._serialized_end = 413
    _globals['_PWMOUTPUTNETNAME']._serialized_start = 415
    _globals['_PWMOUTPUTNETNAME']._serialized_end = 510