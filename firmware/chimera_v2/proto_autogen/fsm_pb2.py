...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 6, 32, 0, '', 'fsm.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_I2CNETNAME']._serialized_start = 469
    _globals['_I2CNETNAME']._serialized_end = 524