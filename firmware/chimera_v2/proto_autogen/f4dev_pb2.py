...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GPIONETNAME']._serialized_end = 78
    _globals['_ADCNETNAME']._serialized_start = 80
    _globals['_ADCNETNAME']._serialized_end = 122