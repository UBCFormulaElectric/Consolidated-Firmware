...
class GpioNetName(google.protobuf.message.Message):
    ...
    def __init__(self, *, f4dev_net_name: f4dev_pb2.GpioNetName.ValueType=..., ssm_net_name: ssm_pb2.GpioNetName.ValueType=..., crit_net_name: crit_pb2.GpioNetName.ValueType=..., dam_net_name: dam_pb2.GpioNetName.ValueType=..., rsm_net_name: rsm_pb2.GpioNetName.ValueType=..., fsm_net_name: fsm_pb2.GpioNetName.ValueType=...) -> None:
        ...
...
class AdcNetName(google.protobuf.message.Message):
    ...
    def __init__(self, *, crit_net_name: crit_pb2.AdcNetName.ValueType=..., rsm_net_name: rsm_pb2.AdcNetName.ValueType=..., fsm_net_name: fsm_pb2.AdcNetName.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['crit_net_name', b'crit_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['crit_net_name', b'crit_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name']) -> None:
        ...

    def WhichOneof(self, oneof_group: typing.Literal['name', b'name']) -> typing.Literal['crit_net_name', 'rsm_net_name', 'fsm_net_name'] | None:
        ...
...
class I2cNetName(google.protobuf.message.Message):
    ...
    def __init__(self, *, crit_net_name: crit_pb2.I2cNetName.ValueType=..., dam_net_name: dam_pb2.I2cNetName.ValueType=..., rsm_net_name: rsm_pb2.I2cNetName.ValueType=..., fsm_net_name: fsm_pb2.I2cNetName.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['crit_net_name', b'crit_net_name', 'dam_net_name', b'dam_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['crit_net_name', b'crit_net_name', 'dam_net_name', b'dam_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name']) -> None:
        ...

    def WhichOneof(self, oneof_group: typing.Literal['name', b'name']) -> typing.Literal['crit_net_name', 'dam_net_name', 'rsm_net_name', 'fsm_net_name'] | None:
        ...
...
class SpiNetName(google.protobuf.message.Message):
    ...
    def __init__(self, *, crit_net_name: crit_pb2.SpiNetName.ValueType=...) -> None:
        ...
