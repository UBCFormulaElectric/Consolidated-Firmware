...
class GpioNetName(google.protobuf.message.Message):
    ...
    def __init__(self, *, f4dev_net_name: f4dev_pb2.GpioNetName.ValueType=..., ssm_net_name: ssm_pb2.GpioNetName.ValueType=..., crit_net_name: crit_pb2.GpioNetName.ValueType=..., bms_net_name: bms_pb2.GpioNetName.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['bms_net_name', b'bms_net_name', 'crit_net_name', b'crit_net_name', 'f4dev_net_name', b'f4dev_net_name', 'name', b'name', 'ssm_net_name', b'ssm_net_name']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['bms_net_name', b'bms_net_name', 'crit_net_name', b'crit_net_name', 'f4dev_net_name', b'f4dev_net_name', 'name', b'name', 'ssm_net_name', b'ssm_net_name']) -> None:
        ...

    def WhichOneof(self, oneof_group: typing.Literal['name', b'name']) -> typing.Literal['f4dev_net_name', 'ssm_net_name', 'crit_net_name', 'bms_net_name'] | None:
        ...
...
class AdcNetName(google.protobuf.message.Message):
    ...
    def __init__(self, *, f4dev_net_name: f4dev_pb2.AdcNetName.ValueType=..., ssm_net_name: ssm_pb2.AdcNetName.ValueType=..., crit_net_name: crit_pb2.AdcNetName.ValueType=..., bms_net_name: bms_pb2.AdcNetName.ValueType=...) -> None:
        ...
...
class I2cNetName(google.protobuf.message.Message):
    ...
    def __init__(self, *, f4dev_net_name: f4dev_pb2.I2cNetName.ValueType=..., ssm_net_name: ssm_pb2.I2cNetName.ValueType=..., crit_net_name: crit_pb2.I2cNetName.ValueType=..., bms_net_name: bms_pb2.I2cNetName.ValueType=...) -> None:
        ...
