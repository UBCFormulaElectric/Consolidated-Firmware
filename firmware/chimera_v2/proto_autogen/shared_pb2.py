...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GPIOREAD']._serialized_end = 155
    _globals['_GPIOWRITE']._serialized_start = 157
    _globals['_GPIOWRITE']._serialized_end = 215
    _globals['_ADCNETNAME']._serialized_start = 217
    _globals['_ADCNETNAME']._serialized_end = 282
    _globals['_ADC']._serialized_start = 284
    _globals['_ADC']._serialized_end = 335
    _globals['_DEBUGMESSAGE']._serialized_start = 337
    _globals['_DEBUGMESSAGE']._serialized_end = 449