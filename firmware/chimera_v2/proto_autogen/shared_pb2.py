...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_SPITRANSMITREQUEST'].fields_by_name['data']._options = None
    _globals['_SPITRANSMITREQUEST'].fields_by_name['data']._serialized_options = b'\x92?\x03\x08\x80\x01'
    _globals['_SPIRECEIVERESPONSE'].fields_by_name['data']._options = None
    _globals['_SPIRECEIVERESPONSE'].fields_by_name['data']._serialized_options = b'\x92?\x03\x08\x80\x01'
    _globals['_SPITRANSACTIONREQUEST'].fields_by_name['tx_data']._options = None
    _globals['_SPITRANSACTIONREQUEST'].fields_by_name['tx_data']._serialized_options = b'\x92?\x03\x08\x80\x01'
    _globals['_SPITRANSACTIONRESPONSE'].fields_by_name['rx_data']._options = None
    _globals['_SPITRANSACTIONRESPONSE'].fields_by_name['rx_data']._serialized_options = b'\x92?\x03\x08\x80\x01'
    _globals['_GPIONETNAME']._serialized_start = 111
    _globals['_GPIONETNAME']._serialized_end = 432
    _globals['_GPIOREADREQUEST']._serialized_start = 434
    _globals['_GPIOREADREQUEST']._serialized_end = 483
    _globals['_GPIOREADRESPONSE']._serialized_start = 485
    _globals['_GPIOREADRESPONSE']._serialized_end = 518
    _globals['_GPIOWRITEREQUEST']._serialized_start = 520
    _globals['_GPIOWRITEREQUEST']._serialized_end = 585
    _globals['_GPIOWRITERESPONSE']._serialized_start = 587
    _globals['_GPIOWRITERESPONSE']._serialized_end = 623
    _globals['_ADCNETNAME']._serialized_start = 626
    _globals['_ADCNETNAME']._serialized_end = 939
    _globals['_ADCREADREQUEST']._serialized_start = 941
    _globals['_ADCREADREQUEST']._serialized_end = 988
    _globals['_ADCREADRESPONSE']._serialized_start = 990
    _globals['_ADCREADRESPONSE']._serialized_end = 1022
    _globals['_I2CNETNAME']._serialized_start = 1025
    _globals['_I2CNETNAME']._serialized_end = 1338
    _globals['_I2CREADYREQUEST']._serialized_start = 1340
    _globals['_I2CREADYREQUEST']._serialized_end = 1388
    _globals['_I2CREADYRESPONSE']._serialized_start = 1390
    _globals['_I2CREADYRESPONSE']._serialized_end = 1423
    _globals['_I2CRECEIVEREQUEST']._serialized_start = 1425
    _globals['_I2CRECEIVEREQUEST']._serialized_end = 1491
    _globals['_I2CRECEIVERESPONSE']._serialized_start = 1493
    _globals['_I2CRECEIVERESPONSE']._serialized_end = 1535
    _globals['_I2CTRANSMITREQUEST']._serialized_start = 1537
    _globals['_I2CTRANSMITREQUEST']._serialized_end = 1610
    _globals['_I2CTRANSMITRESPONSE']._serialized_start = 1612
    _globals['_I2CTRANSMITRESPONSE']._serialized_end = 1650
    _globals['_I2CMEMORYREADREQUEST']._serialized_start = 1652
    _globals['_I2CMEMORYREADREQUEST']._serialized_end = 1745
    _globals['_I2CMEMORYREADRESPONSE']._serialized_start = 1747
    _globals['_I2CMEMORYREADRESPONSE']._serialized_end = 1792
    _globals['_I2CMEMORYWRITEREQUEST']._serialized_start = 1794
    _globals['_I2CMEMORYWRITEREQUEST']._serialized_end = 1894
    _globals['_I2CMEMORYWRITERESPONSE']._serialized_start = 1896
    _globals['_I2CMEMORYWRITERESPONSE']._serialized_end = 1937
    _globals['_SPINETNAME']._serialized_start = 1940
    _globals['_SPINETNAME']._serialized_end = 2212
    _globals['_SPITRANSMITREQUEST']._serialized_start = 2214
    _globals['_SPITRANSMITREQUEST']._serialized_end = 2287
    _globals['_SPITRANSMITRESPONSE']._serialized_start = 2289
    _globals['_SPITRANSMITRESPONSE']._serialized_end = 2327
    _globals['_SPIRECEIVEREQUEST']._serialized_start = 2329
    _globals['_SPIRECEIVEREQUEST']._serialized_end = 2395
    _globals['_SPIRECEIVERESPONSE']._serialized_start = 2397
    _globals['_SPIRECEIVERESPONSE']._serialized_end = 2439
    _globals['_SPITRANSACTIONREQUEST']._serialized_start = 2441
    _globals['_SPITRANSACTIONREQUEST']._serialized_end = 2539
    _globals['_SPITRANSACTIONRESPONSE']._serialized_start = 2541
    _globals['_SPITRANSACTIONRESPONSE']._serialized_end = 2590
    _globals['_CHIMERAV2REQUEST']._serialized_start = 2593
    _globals['_CHIMERAV2REQUEST']._serialized_end = 3107
    _globals['_CHIMERAV2RESPONSE']._serialized_start = 3110
    _globals['_CHIMERAV2RESPONSE']._serialized_end = 3636