...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SPITRANSMITREQUEST'].fields_by_name['data']._serialized_options = b'\x92?\x03\x08\x80\x08'
    _globals['_SPIRECEIVERESPONSE'].fields_by_name['data']._loaded_options = None
    _globals['_SPIRECEIVERESPONSE'].fields_by_name['data']._serialized_options = b'\x92?\x03\x08\x80\x08'
    _globals['_SPITRANSACTIONREQUEST'].fields_by_name['tx_data']._loaded_options = None
    _globals['_SPITRANSACTIONREQUEST'].fields_by_name['tx_data']._serialized_options = b'\x92?\x03\x08\x80\x08'
    _globals['_SPITRANSACTIONRESPONSE'].fields_by_name['rx_data']._loaded_options = None
    _globals['_SPITRANSACTIONRESPONSE'].fields_by_name['rx_data']._serialized_options = b'\x92?\x03\x08\x80\x08'
    ...
    _globals['_SPINETNAME']._serialized_start = 1670
    _globals['_SPINETNAME']._serialized_end = 1901
    _globals['_SPITRANSMITREQUEST']._serialized_start = 1903
    _globals['_SPITRANSMITREQUEST']._serialized_end = 1976
    _globals['_SPITRANSMITRESPONSE']._serialized_start = 1978
    _globals['_SPITRANSMITRESPONSE']._serialized_end = 2016
    _globals['_SPIRECEIVEREQUEST']._serialized_start = 2018
    _globals['_SPIRECEIVEREQUEST']._serialized_end = 2084
    _globals['_SPIRECEIVERESPONSE']._serialized_start = 2086
    _globals['_SPIRECEIVERESPONSE']._serialized_end = 2128
    _globals['_SPITRANSACTIONREQUEST']._serialized_start = 2130
    _globals['_SPITRANSACTIONREQUEST']._serialized_end = 2228
    _globals['_SPITRANSACTIONRESPONSE']._serialized_start = 2230
    _globals['_SPITRANSACTIONRESPONSE']._serialized_end = 2279
    _globals['_CHIMERAV2REQUEST']._serialized_start = 2282
    _globals['_CHIMERAV2REQUEST']._serialized_end = 2796
    _globals['_CHIMERAV2RESPONSE']._serialized_start = 2799
    _globals['_CHIMERAV2RESPONSE']._serialized_end = 3325