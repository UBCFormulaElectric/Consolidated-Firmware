...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_ADCNETNAME']._serialized_start = 312
    _globals['_ADCNETNAME']._serialized_end = 444
    _globals['_I2CNETNAME']._serialized_start = 446
    _globals['_I2CNETNAME']._serialized_end = 504
    _globals['_SPINETNAME']._serialized_start = 506
    _globals['_SPINETNAME']._serialized_end = 561