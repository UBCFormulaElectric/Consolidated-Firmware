...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SPINETNAME']._serialized_start = 311
    _globals['_SPINETNAME']._serialized_end = 390
    _globals['_PWMNETNAME']._serialized_start = 392
    _globals['_PWMNETNAME']._serialized_end = 466