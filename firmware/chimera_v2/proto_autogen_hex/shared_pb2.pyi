...
class SpiNetName(_message.Message):
    ...
    def __init__(self, *, bms_net_name: _bms_pb2.SpiNetName.ValueType=..., crit_net_name: _crit_pb2.SpiNetName.ValueType=..., rsm_net_name: _rsm_pb2.SpiNetName.ValueType=..., fsm_net_name: _fsm_pb2.SpiNetName.ValueType=...) -> None:
        ...
    _HasFieldArgType: _TypeAlias = _typing.Literal['bms_net_name', b'bms_net_name', 'crit_net_name', b'crit_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name']

    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool:
        ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal['bms_net_name', b'bms_net_name', 'crit_net_name', b'crit_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name']

    def ClearField(self, field_name: _ClearFieldArgType) -> None:
        ...
    _WhichOneofReturnType_name: _TypeAlias = _typing.Literal['bms_net_name', 'crit_net_name', 'rsm_net_name', 'fsm_net_name']
    _WhichOneofArgType_name: _TypeAlias = _typing.Literal['name', b'name']
