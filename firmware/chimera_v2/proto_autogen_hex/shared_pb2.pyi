...
class SpiNetName(google.protobuf.message.Message):
    ...
    def __init__(self, *, bms_net_name: bms_pb2.SpiNetName.ValueType=..., crit_net_name: crit_pb2.SpiNetName.ValueType=..., rsm_net_name: rsm_pb2.SpiNetName.ValueType=..., fsm_net_name: fsm_pb2.SpiNetName.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['bms_net_name', b'bms_net_name', 'crit_net_name', b'crit_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['bms_net_name', b'bms_net_name', 'crit_net_name', b'crit_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name']) -> None:
        ...

    def WhichOneof(self, oneof_group: typing.Literal['name', b'name']) -> typing.Literal['bms_net_name', 'crit_net_name', 'rsm_net_name', 'fsm_net_name'] | None:
        ...
