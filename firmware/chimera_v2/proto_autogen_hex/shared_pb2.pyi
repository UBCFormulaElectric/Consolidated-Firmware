...
class GpioNetName(google.protobuf.message.Message):
    ...
    def __init__(self, *, crit_net_name: crit_pb2.GpioNetName.ValueType=..., dam_net_name: dam_pb2.GpioNetName.ValueType=..., rsm_net_name: rsm_pb2.GpioNetName.ValueType=..., fsm_net_name: fsm_pb2.GpioNetName.ValueType=..., bms_net_name: bms_pb2.GpioNetName.ValueType=..., vc_net_name: vc_pb2.GpioNetName.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['bms_net_name', b'bms_net_name', 'crit_net_name', b'crit_net_name', 'dam_net_name', b'dam_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name', 'vc_net_name', b'vc_net_name']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['bms_net_name', b'bms_net_name', 'crit_net_name', b'crit_net_name', 'dam_net_name', b'dam_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name', 'vc_net_name', b'vc_net_name']) -> None:
        ...

    def WhichOneof(self, oneof_group: typing.Literal['name', b'name']) -> typing.Literal['crit_net_name', 'dam_net_name', 'rsm_net_name', 'fsm_net_name', 'bms_net_name', 'vc_net_name'] | None:
        ...
...
class I2cNetName(google.protobuf.message.Message):
    ...
    def __init__(self, *, rsm_net_name: rsm_pb2.I2cNetName.ValueType=..., vc_net_name: vc_pb2.I2cNetName.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['name', b'name', 'rsm_net_name', b'rsm_net_name', 'vc_net_name', b'vc_net_name']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['name', b'name', 'rsm_net_name', b'rsm_net_name', 'vc_net_name', b'vc_net_name']) -> None:
        ...
...
class SpiNetName(google.protobuf.message.Message):
    ...
    vc_net_name: vc_pb2.SpiNetName.ValueType

    def __init__(self, *, bms_net_name: bms_pb2.SpiNetName.ValueType=..., crit_net_name: crit_pb2.SpiNetName.ValueType=..., rsm_net_name: rsm_pb2.SpiNetName.ValueType=..., fsm_net_name: fsm_pb2.SpiNetName.ValueType=..., vc_net_name: vc_pb2.SpiNetName.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['bms_net_name', b'bms_net_name', 'crit_net_name', b'crit_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name', 'vc_net_name', b'vc_net_name']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['bms_net_name', b'bms_net_name', 'crit_net_name', b'crit_net_name', 'fsm_net_name', b'fsm_net_name', 'name', b'name', 'rsm_net_name', b'rsm_net_name', 'vc_net_name', b'vc_net_name']) -> None:
        ...
...
class UartNetName(google.protobuf.message.Message):
    ...
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    DAM_NET_NAME_FIELD_NUMBER: builtins.int
    dam_net_name: dam_pb2.UartNetName.ValueType

    def __init__(self, *, dam_net_name: dam_pb2.UartNetName.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['dam_net_name', b'dam_net_name', 'name', b'name']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['dam_net_name', b'dam_net_name', 'name', b'name']) -> None:
        ...
...
class PwmNetName(google.protobuf.message.Message):
    ...
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    CRIT_NET_NAME_FIELD_NUMBER: builtins.int
    crit_net_name: crit_pb2.PwmNetName.ValueType

    def __init__(self, *, crit_net_name: crit_pb2.PwmNetName.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['crit_net_name', b'crit_net_name', 'name', b'name']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['crit_net_name', b'crit_net_name', 'name', b'name']) -> None:
        ...
...
class ChimeraV2Request(google.protobuf.message.Message):
    ...
    UART_RECEIVE_FIELD_NUMBER: builtins.int
    UART_TRANSMIT_FIELD_NUMBER: builtins.int
