 ...
 */
uint32_t app_crc32_reflect(uint32_t data, size_t data_len);
 ...
 */
static inline uint32_t app_crc32_init(void)
{
    return 0xffffffff;
}
 ...
 */
uint32_t app_crc32_update(uint32_t crc, const void *data, size_t data_len);
