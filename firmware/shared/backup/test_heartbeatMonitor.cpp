...
TEST(HeartbeatMonitorTest, test_check_faults)
{
    /* test check faults */
    ...
    app_heartbeatMonitor_init(
        100, heartbeatsToCheck, heartbeatCanGetters, heartbeatCanUpdaters, &FSM_fakeCanHeartbeatSetter, faultCanSetters,
        faultCanGetters);
...
TEST(HeartbeatMonitorTest, test_broadcast_faults)
{
...
// TEST(HeartbeatMonitorTest, test_check_in_and_tick)
// {
