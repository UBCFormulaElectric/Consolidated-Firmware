...
{
    EnterChargeStateClean();
    fakes::segments::setMaxCellVoltage(4.0f);
    app::can_rx::Elcon_OutputCurrent_update(0.5f);
    LetTimePass(10);
...
TEST_F(BmsChargeStateTest, taper_at_midpoint_halves_current)
{
    ...
    EnterChargeStateClean();
    fakes::segments::setMaxCellVoltage(4.15f);
    LetTimePass(10);
...
TEST_F(BmsChargeStateTest, taper_at_taper_start_commands_full_current)
{
    ...
    EnterChargeStateClean();
    fakes::segments::setMaxCellVoltage(4.10f);
    LetTimePass(10);
...
TEST_F(BmsChargeStateTest, current_clamped_to_zero_at_per_cell_max)
{
    ...
    EnterChargeStateClean();
    fakes::segments::setMaxCellVoltage(4.20f);
    LetTimePass(10);
...
TEST_F(BmsChargeStateTest, current_clamped_to_zero_above_per_cell_max)
{
    ...
    EnterChargeStateClean();
    fakes::segments::setMaxCellVoltage(4.25f);
    app::can_rx::Elcon_OutputCurrent_update(2.0f);
    LetTimePass(10);
