...
#define nEVSE_I_LIM_GPIO_GPIO_Port GPIOE
    ...
    /* CubeMX user constants (BMS.ioc Mcu.UserConstants) — used by hw_pwms.cpp and main.c */
#define TIMx_FREQUENCY 256000000UL
#define TIM3_PRESCALER 10U
#define ADC_FREQUENCY 1000U
#define LSI_FREQUENCY 32000U
#define IWDG_PRESCALER 4U
#define IWDG_RESET_FREQUENCY 5U
#define IWDG_WINDOW_DISABLE_VALUE 4095U
#define TIM1_AUTO_RELOAD_REG 0xFFFFU
#define TIM5_AUTO_RELOAD_REG 0xFFFFU
#define TIM1_PWM_MIN_FREQUENCY 1U
#define TIM5_PWM_MIN_FREQUENCY 1U
