...
void HAL_ADC_MspInit(ADC_HandleTypeDef *hadc)
{
    ...
    if (hadc->Instance == ADC1)
    {
        ...
        */
        GPIO_InitStruct.Pin =
            EMETER_THERM_SNS_Pin | nEVSE_I_LIM_PWM_Pin | TS_ISENSE_400A_Pin | TS_ISENSE_50A_Pin | FAN_ISNS_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef *hadc)
{
    if (hadc->Instance == ADC1)
    {
        ...
        */
        HAL_GPIO_DeInit(
            GPIOA, EMETER_THERM_SNS_Pin | nEVSE_I_LIM_PWM_Pin | TS_ISENSE_400A_Pin | TS_ISENSE_50A_Pin | FAN_ISNS_Pin);
...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef *hfdcan)
{
    ...
    else if (hfdcan->Instance == FDCAN2)
    {
        ...
        PB6     ------> FDCAN2_TX
        */
        HAL_GPIO_DeInit(GPIOB, CAN1_CHRG_RX_Pin | CAN1_CHRG_TX_Pin);
