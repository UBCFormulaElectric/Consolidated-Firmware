...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_INP5
    */
    GPIO_InitStruct.Pin = EMETER_THERM_SNS_Pin|TS_ISENSE_400A_Pin|TS_ISENSE_50A_Pin|FAN_ISNS_Pin
                          |SHDN_SNS_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(GPIOA, EMETER_THERM_SNS_Pin|TS_ISENSE_400A_Pin|TS_ISENSE_50A_Pin|FAN_ISNS_Pin
                          |SHDN_SNS_Pin);
