...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, IR_P_EN_Pin|SHDN_EN_Pin|PRE_CHARGE_EN_Pin|SHDN_OL_ON_Pin
                          |FAN_EN_Pin|nBMS_OK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, BSPD_TEST_EN_Pin|SPI_CS_HS_Pin|TSENSE_SEL0_Pin|TSENSE_SEL1_Pin
                          |TSENSE_SEL2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MSD_SHDN_SNS_Pin HV_P_INTLCK_SNS_Pin HV_N_INTLCK_SNS_Pin nIMD_LATCH_Pin
                           SD_CD_Pin */
  GPIO_InitStruct.Pin = MSD_SHDN_SNS_Pin|HV_P_INTLCK_SNS_Pin|HV_N_INTLCK_SNS_Pin|nIMD_LATCH_Pin
                          |SD_CD_Pin;
  ...
  GPIO_InitStruct.Pin = nBMS_LATCH_Pin|IMD_OK_Pin|nBSPD_LATCH_Pin|FAN_PGOOD_Pin
                          |nEVSE_I_LIM_GPIO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
