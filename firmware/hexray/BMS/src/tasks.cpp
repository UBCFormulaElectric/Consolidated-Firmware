...
static hw::rtos::StaticTask TaskCanRx(TaskCanRxStack, 512, osPriorityBelowNormal, "TaskCanRx", tasks_runCanRx);
static hw::rtos::StaticTask TaskCanTx(TaskCanTxStack, 512, osPriorityBelowNormal, "TaskCanTx", tasks_runCanTx);
