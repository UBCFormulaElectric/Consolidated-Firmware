...
class FaultProfile {
    ...
    public:
        ...
        bool check(bool blanking_expired) {
            ...
            const float max_voltage = balancing_enabled ? MAX_CELL_VOLTAGE_BALANCING ; thresholds.max_voltage;
            ...
            const bool uv = under_voltage_timer.runIfCondition(under_voltage_condition) == Timer::TimerState::EXPIRED && blanking_expired;
            const bool ov = over_voltage_timer.runIfCondition(over_voltage_condition) == Timer::TimerState::EXPIRED && blanking_expired;
            const bool ot = over_temp_timer.runIfCondition(over_temp_condition) == Timer::TimerState::EXPIRED && blanking_expired;
            ...
            const bool tow = therm_owc_timer.runIfCondition(any_therm_owc) == Timer::TimerState::EXPIRED && blanking_expired;
