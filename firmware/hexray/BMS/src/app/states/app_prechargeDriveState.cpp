...
const ::app::State precharge_drive_state = {
    ...
    .run_on_entry      = prechargeDriveState::prechargeDriveStateRunOnEntry,
    .run_on_tick_1Hz   = nullptr,
    .run_on_tick_100Hz = prechargeDriveState::prechargeDriveStateRunOnTick100Hz,
    .run_on_exit       = prechargeDriveState::prechargeDriveStateRunOnExit,
};
} // namespace app::states
