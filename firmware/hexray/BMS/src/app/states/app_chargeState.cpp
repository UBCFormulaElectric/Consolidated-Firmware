...
namespace chargeState
{
    ...
    static void runOnTick100Hz()
    {
        ...
        const bool chargerConn =
            true; // (charger_connection_status == CHARGER_CONNECTED_EVSE || CHARGER_CONNECTED_WALL);
...
const ::app::State charge_fault_state = {
    .name              = "CHARGE FAULT",
    .run_on_entry      = chargeFaultState::runOnEntry,
    .run_on_tick_1Hz   = nullptr,
    .run_on_tick_100Hz = chargeFaultState::runOnTick100Hz,
    .run_on_exit       = chargeFaultState::runOnExit,
};

// Charge init state implementation
namespace chargeInitState
{
    static void runOnEntry()
    {
...
const ::app::State charge_init_state = {
    .name              = "CHARGE INIT",
    .run_on_entry      = chargeInitState::runOnEntry,
    .run_on_tick_1Hz   = nullptr,
    .run_on_tick_100Hz = chargeInitState::runOnTick100Hz,
    .run_on_exit       = chargeInitState::runOnExit,
};
} // namespace app::states