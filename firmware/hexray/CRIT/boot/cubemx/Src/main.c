...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOC, LED_BOOT_Pin | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_6 | GPIO_PIN_10, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : LED_BOOT_Pin PC1 PC2 PC6
                             PC10 */
    GPIO_InitStruct.Pin   = LED_BOOT_Pin | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_6 | GPIO_PIN_10;
