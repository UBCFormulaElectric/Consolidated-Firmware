...
int hwpwmInputFreqOnly_init{return 0;}
int hw_pwmInputFreqOnly_getFrequency{return 0;}
bool hw_pwmInputFreqOnly_checkIfPwmIsActive{return true;}
...
void_io_coolant_checkIfFlowMeterActive()
{
