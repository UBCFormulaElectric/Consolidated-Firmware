...
static void MX_GPIO_Init(void)
{
    ...
    /*Configure GPIO pins : BRAKE_OCSC_OK_3V3_Pin SUSP_TRAVEL_RL_OCSC_Pin FLOW_METER_5V_Pin */
    GPIO_InitStruct.Pin  = BRAKE_OCSC_OK_3V3_Pin | SUSP_TRAVEL_RL_OCSC_Pin | FLOW_METER_5V_Pin;
