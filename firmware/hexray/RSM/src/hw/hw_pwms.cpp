...
namespace hw::pwm
{
constexpr PwmInput flow_meter_config{ htim1,   HAL_TIM_ACTIVE_CHANNEL_1, TIM1_FREQUENCY, TIM_CHANNEL_1, TIM_CHANNEL_2,
                                      TIM1_ARR };
} // namespace hw::pwm
...
extern "C"
{
    ...
    {
        assert(htim == &hw::pwm::flow_meter_config.get_timer_handle());
