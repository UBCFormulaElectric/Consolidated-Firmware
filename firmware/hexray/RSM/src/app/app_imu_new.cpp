...
{   
    ...
    imu_faults.accel_x_fault   = io::imus::imu_config.getAccelX(&accel_x);
    imu_faults.accel_y_fault   = io::imus::imu_config.getAccelY(&accel_x);
    imu_faults.accel_z_fault   = io::imus::imu_config.getAccelZ(&accel_x);
    imu_faults.accel_x_fault  = io::imus::imu_config.getGyroX(&gyro_x);
    imu_faults.accel_y_fault  = io::imus::imu_config.getGyroY(&gyro_y);
    imu_faults.accel_z_fault  = io::imus::imu_config.getGyroZ(&gyro_z);
