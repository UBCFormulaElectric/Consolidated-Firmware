...
static constexpr std::array<std::reference_wrapper<io::heartbeat::node>, 5> hb_nodes{
    { bms_heartbeat_node, crit_heartbeat_node, dam_heartbeat_node, fsm_heartbeat_node, vc_heartbeat_node }
};
const app::heartbeat::monitor<5> hb_monitor(app::can_tx::RSM_Heartbeat_set, hb_nodes);
