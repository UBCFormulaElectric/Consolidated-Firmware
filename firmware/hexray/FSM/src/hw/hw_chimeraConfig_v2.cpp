...
const Gpio *id_to_gpio[] = {
    ...
    [fsm_GpioNetName_GPIO_IMU_FSYNC] = &imu_fsync,                [fsm_GpioNetName_GPIO_NSUSP_FL_OCSC] = &nsusp_fl_ocsc, 
    [fsm_GpioNetName_GPIO_NSUSP_FR_OCSC] = &nsusp_fr_ocsc,      [fsm_GpioNetName_GPIO_FR_INT_3v3] = &fr_int_3v3,       
    [fsm_GpioNetName_GPIO_FL_INT_3v3] = &fl_int_3v3,            [fsm_GpioNetName_GPIO_DEBUG_LED] = &debug_led,         
    [fsm_GpioNetName_GPIO_NSTR_ANGLE_OCSC] = &nstr_angle_ocsc,  [fsm_GpioNetName_GPIO_NBPS_F_OCSC] = &nbps_f_ocsc,     
...
const SpiDevice
    *id_to_spi[] = { [fsm_SpiNetName_SPI_IMU] = &imu_spi };
