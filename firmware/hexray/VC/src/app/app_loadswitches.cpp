...
std::array<EfuseCanMsg, NUM_EFUSE_CHANNELS> efuse_channel_setters{ {
    ...
    { r_inv_efuse, can_tx::VC_RearInvertersStatus_set, can_tx::VC_RearInvertersCurrent_set },
    { bms_efuse, can_tx::VC_BMSStatus_set, can_tx::VC_BMSCurrent_set },
    { rsm_efuse, can_tx::VC_RSMStatus_set, can_tx::VC_RSMCurrent_set },
    ...
    { l_rad_fan_efuse, can_tx::VC_LeftRadiatorFanStatus_set, can_tx::VC_LeftRadiatorFanCurrent_set },
    ...
    { rl_pump_efuse, can_tx::VC_RearLeftPumpStatus_set, can_tx::VC_RearLeftPumpCurrent_set },
} };
