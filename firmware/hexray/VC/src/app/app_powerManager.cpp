...
void updateConfig(const PowerManagerConfig &new_cfg)
{
    ...
    state_.efuse_configs[0].efuse_enable = state_.efuse_configs[0].efuse_enable ? !under_v: state_.efuse_configs[0].efuse_enable;
    state_.efuse_configs[2].efuse_enable = state_.efuse_configs[2].efuse_enable ? !under_v: state_.efuse_configs[2].efuse_enable;
    state_.efuse_configs[1].efuse_enable = state_.efuse_configs[1].efuse_enable ? !under_v: state_.efuse_configs[1].efuse_enable;
    state_.efuse_configs[3].efuse_enable = state_.efuse_configs[3].efuse_enable ? !under_v: state_.efuse_configs[3].efuse_enable;
}
