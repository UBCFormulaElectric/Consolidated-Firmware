...
app::powerManager{
    ...
    }   // works like a private class since its anoymous and local to this namespace
...
#ifdef TARGET_TEST
PowerManagerConfig getConfig() { return state_; }
bool getEfuse(int channel) { return state_.efuse_configs[channel].efuse_enable;}
