...
extern io::TI_TPS25_Efuse RR_PUMP_Efuse{ &rr_pump_en, &adc_rr_pump, &rr_pump_pgood };
extern io::TI_TPS25_Efuse RL_PUMP_Efuse{ &rl_pump_en, &adc_rl_pump, &rl_pump_pgood };
extern io::TI_TPS25_Efuse R_RAD_Efuse{ &r_rad_fan_en, &adc_r_rad_fan, &r_rad_fan_pg };
