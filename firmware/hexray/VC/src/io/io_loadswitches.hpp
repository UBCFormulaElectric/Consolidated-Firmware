...
const bool                io_TILoadswitch_pgood(const *temp);
extern io::TI_TPS25_Efuse RR_PUMP_Efuse{ &rr_pump_en, &adc_rr_pump, &rr_pump_pgood, &rr_pump_en };
extern io::TI_TPS25_Efuse RL_PUMP_Efuse{ &rl_pump_en, &adc_rl_pump, &rl_pump_pgood, &rl_pump_en };
extern io::TI_TPS25_Efuse R_RAD_Efuse{ &r_rad_fan_en, &adc_r_rad_fan, &r_rad_fan_pg, &r_rad_fan_en };
extern io::TI_TPS25_Efuse L_RAD_Efuse{ &l_rad_fan_en, &adc_l_rad_fan, &l_rad_fan_pg, &l_rad_fan_en };
extern io::TI_TPS28_Efuse F_INV_Efuse{ &f_inv_en, &adc_f_inv, &f_inv_pg, &f_inv_en };
extern io::TI_TPS28_Efuse R_INV_Efuse{ &r_inv_en, &adc_r_inv, &r_inv_pg, &r_inv_en };
