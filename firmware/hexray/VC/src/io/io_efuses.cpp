...
//constexpr io::TI_TPS28_Efuse misc_fuse_efuse(misc_fuse_en, hw::adcs::adc_misc_fuse, misc_fuse_pg, misc_fuse_en); (potential addee)
...
const Efuse *efuses[NUM_EFUSE_CHANNELS] = {
    &io::f_inv_efuse, &io::rsm_efuse,
    &io::bms_efuse, &io::r_inv_efuse,
    &io::dam_efuse, &io::front_efuse,
    &io::rl_pump_efuse, &io::r_rad_fan_efuse
};
} // namespace io 
