...
static hw::rtos::StaticTask::StaticTaskStack<512>  tasks_batteryMonitoringStack;
...
static hw::rtos::StaticTask TaskBatteryMonitoring(osPriorityNormal, "TaskBatteryMonitoring", tasks_batteryMonitoring, tasks_batteryMonitoringStack);
