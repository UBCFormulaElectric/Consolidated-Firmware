...
static void MX_GPIO_Init(void)
{
    ...
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOB, BMS_EN_Pin | FRONT_EN_Pin, GPIO_PIN_SET);
    ...
    /*Configure GPIO pins : BMS_EN_Pin FRONT_EN_Pin */
    GPIO_InitStruct.Pin   = BMS_EN_Pin | FRONT_EN_Pin;
    GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull  = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

    /*Configure GPIO pin : RSM_EN_Pin */
    GPIO_InitStruct.Pin   = RSM_EN_Pin;
    GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull  = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(RSM_EN_GPIO_Port, &GPIO_InitStruct);

    /*Configure GPIO pin : DAM_EN_Pin */
    GPIO_InitStruct.Pin   = DAM_EN_Pin;
    GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull  = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(DAM_EN_GPIO_Port, &GPIO_InitStruct);
