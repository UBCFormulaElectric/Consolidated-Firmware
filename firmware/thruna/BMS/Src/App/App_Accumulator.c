...
bool App_Accumulator_CheckFaults(struct Accumulator *const accumulator, struct TractiveSystem *const ts)
{
    ...
    App_CanAlerts_CellUndervoltageFault_Set(undervoltage_fault);
    App_CanAlerts_CellOvervoltageFault_Set(overvoltage_fault);
    App_CanAlerts_CellUndertempFault_Set(undertemp_fault);
    App_CanAlerts_CellOvertempFault_Set(overtemp_fault);
    App_CanAlerts_ModuleCommunicationFault_Set(communication_fault);
