...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, AIR_EN_Pin|PRE_CHARGE_EN_Pin|AUX_TSENSE_MUX1_Pin|AUX_TSENSE_MUX2_Pin
  ...
  /*Configure GPIO pins : AIR_EN_Pin PRE_CHARGE_EN_Pin AUX_TSENSE_MUX1_Pin AUX_TSENSE_MUX2_Pin
                           AUX_TSENSE_MUX3_Pin */
  GPIO_InitStruct.Pin = AIR_EN_Pin|PRE_CHARGE_EN_Pin|AUX_TSENSE_MUX1_Pin|AUX_TSENSE_MUX2_Pin
                          |AUX_TSENSE_MUX3_Pin;
