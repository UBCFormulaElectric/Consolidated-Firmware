...
{
    App_CanAlerts_DIM_StackWaterMarkHighTask1HzWarning_Set(true);
}

static void logWaterMarkAboveThresholdTask100Hz(uint8_t error)
{
    App_CanAlerts_DIM_StackWaterMarkHighTask100HzWarning_Set(true);
}

static void logWaterMarkAboveThresholdTask1kHz(uint8_t error)
{
    App_CanAlerts_DIM_StackWaterMarkHighTask1kHzWarning_Set(true);
}

static void logWaterMarkAboveThresholdTaskCanRx(uint8_t error)
{
    App_CanAlerts_DIM_StackWaterMarkHighTaskCanRxWarning_Set(true);
}

static void logWaterMarkAboveThresholdTaskCanTx(uint8_t error)
{
    App_CanAlerts_DIM_StackWaterMarkHighTaskCanTxWarning_Set(true);
}
