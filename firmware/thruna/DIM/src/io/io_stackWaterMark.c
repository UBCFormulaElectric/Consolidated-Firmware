...
{
    App_CanTx_DIM_StackRemainingTask1Hz_Set(error);
}
static void logStackRemainingTask100Hz(uint8_t error)
{
    App_CanTx_DIM_StackRemainingTask100Hz_Set(error);
}
static void logStackRemainingTask1kHz(uint8_t error)
{
    App_CanTx_DIM_StackRemainingTask1kHz_Set(error);
}
static void logStackRemainingTaskCanRx(uint8_t error)
{
    App_CanTx_DIM_StackRemainingTaskCanRx_Set(error);
}
static void logStackRemainingTaskCanTx(uint8_t error)
{
    App_CanTx_DIM_StackRemainingTaskCanTx_Set(error);
}
