...
void App_AcceleratorPedals_Broadcast(const struct FsmWorld *world)
{
    ...
    App_CanAlerts_SetFault(PappsOCSCFault, papps_ocsc_active);
    ...
    App_CanAlerts_SetFault(SappsOCSCFault, sapps_ocsc_active);
    ...
    App_CanAlerts_SetWarning(AppsDisagreementWarning, apps_disagreement);
    ...
    App_CanAlerts_SetWarning(BrakeAppsDisagreementWarning, brake_acc_disagreement);
