...
void App_Coolant_Broadcast(const struct FsmWorld *world)
{
    ...
    App_CanAlerts_SetWarning(FlowRateOutOfRangeWarning, coolant_status != VALUE_IN_RANGE);
    ...
    App_CanAlerts_SetFault(FlowMeterUnderflowFault, flow_in_range_signal_state == SIGNAL_STATE_ACTIVE);
}
