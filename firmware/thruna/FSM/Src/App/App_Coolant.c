...
void App_Coolant_Broadcast(const struct FsmWorld *world)
{
    ...
    App_CanTx_FSM_TemperatureA_Set(coolant->get_temperature_A());
    App_CanTx_FSM_TemperatureB_Set(coolant->get_temperature_B());
    App_CanTx_FSM_PressureA_Set(coolant->get_pressure_A());
    App_CanTx_FSM_PressureB_Set(coolant->get_pressure_B());
    ...
    App_CanTx_FSM_FlowRate_Set(coolant_flow_clamped);
