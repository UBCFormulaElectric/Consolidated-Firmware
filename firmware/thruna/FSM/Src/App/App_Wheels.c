...
void App_Wheels_Broadcast(const struct FsmWorld *world)
{
    ...
    App_CanAlerts_SetWarning(LeftWheelSpeedOutOfRangeWarning, left_wheel_status != VALUE_IN_RANGE);
    ...
    App_CanAlerts_SetWarning(RightWheelSpeedOutOfRangeWarning, right_wheel_status != VALUE_IN_RANGE);
}
