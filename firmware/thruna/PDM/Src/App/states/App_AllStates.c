...
void App_AllStatesRunOnTick100Hz(struct StateMachine *const state_machine)
{
    ...
    App_CanTx_PDM_BatVoltage_Set(App_LowVoltageBattery_GetBatVoltage(lv_battery));
    App_CanTx_PDM_AccVoltage_Set(App_LowVoltageBattery_GetAccVoltage(lv_battery));
    App_CanTx_PDM_BoostVoltage_Set(App_LowVoltageBattery_GetBoostVoltage(lv_battery));
