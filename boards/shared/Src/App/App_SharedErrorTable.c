...
#include "../../../cmake-build-gtest/BMS/Inc/App/App_ErrorId.h"
...
struct ErrorTable *App_SharedErrorTable_Create(void)
{
    ...
    INIT_ERROR(FSM_NON_CRITICAL_FLOW_RATE_OUT_OF_RANGE, FSM, NON_CRITICAL_ERROR);
    ...
    INIT_ERROR(FSM_NON_CRITICAL_BRAKE_PRESSURE_OPEN_SC, FSM, NON_CRITICAL_ERROR);
    INIT_ERROR(FSM_NON_CRITICAL_BRAKE_PRESSURE_OPEN_OC, FSM, NON_CRITICAL_ERROR);
    ...
    INIT_ERROR(PDM_NON_CRITICAL_EFUSE1_AIR_CURRENT_OUT_OF_RANGE, PDM, NON_CRITICAL_ERROR);
    INIT_ERROR(PDM_NON_CRITICAL_EFUSE1_LV_POWER_CURRENT_OUT_OF_RANGE, PDM, NON_CRITICAL_ERROR);
    INIT_ERROR(PDM_NON_CRITICAL_EFUSE2_EMETER_CURRENT_OUT_OF_RANGE, PDM, NON_CRITICAL_ERROR);
    INIT_ERROR(PDM_NON_CRITICAL_EFUSE2_AUX_CURRENT_OUT_OF_RANGE, PDM, NON_CRITICAL_ERROR);
    INIT_ERROR(PDM_NON_CRITICAL_EFUSE3_LEFT_INVERTER_CURRENT_OUT_OF_RANGE,PDM, NON_CRITICAL_ERROR);
    INIT_ERROR(PDM_NON_CRITICAL_EFUSE3_RIGHT_INVERTER_CURRENT_OUT_OF_RANGE, PDM, NON_CRITICAL_ERROR);
    INIT_ERROR(PDM_NON_CRITICAL_EFUSE4_DRS_CURRENT_OUT_OF_RANGE,PDM, NON_CRITICAL_ERROR);
    INIT_ERROR(PDM_NON_CRITICAL_EFUSE4_FAN_CURRENT_OUT_OF_RANGE,PDM, NON_CRITICAL_ERROR);
