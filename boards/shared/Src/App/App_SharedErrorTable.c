...
struct ErrorTable *App_SharedErrorTable_Create(void)
{
    ...
    INIT_ERROR(BMS_NON_CRITICAL_STACK_WATERMARK_ABOVE_THRESHOLD_TASK10HZ, BMS, NON_CRITICAL_ERROR);
    INIT_ERROR(BMS_NON_CRITICAL_STACK_WATERMARK_ABOVE_THRESHOLD_TASK100HZ, BMS, NON_CRITICAL_ERROR);
