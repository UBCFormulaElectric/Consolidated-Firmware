...
struct ErrorTable *App_SharedErrorTable_Create(void)
{
    ...
    INIT_ERROR(PDM_NON_CRITICAL__24V_BOOST_OUT_VOLTAGE_OUT_OF_RANGE, PDM, NON_CRITICAL_ERROR);
    ...
    INIT_ERROR(PDM_NON_CRITICAL_BACK_LEFT_INVERTER_CURRENT_OUT_OF_RANGE, PDM, NON_CRITICAL_ERROR);
    INIT_ERROR(PDM_NON_CRITICAL_BACK_RIGHT_INVERTER_CURRENT_OUT_OF_RANGE, PDM, NON_CRITICAL_ERROR);
    INIT_ERROR(PDM_NON_CRITICAL_FRONT_LEFT_INVERTER_CURRENT_OUT_OF_RANGE, PDM, NON_CRITICAL_ERROR);
    INIT_ERROR(PDM_NON_CRITICAL_FRONT_RIGHT_INVERTER_CURRENT_OUT_OF_RANGE, PDM, NON_CRITICAL_ERROR);
    ...
    INIT_ERROR(FSM_MOTOR_SHUTDOWN_DUMMY_MOTOR_SHUTDOWN, FSM, MOTOR_SHUTDOWN_ERROR);
