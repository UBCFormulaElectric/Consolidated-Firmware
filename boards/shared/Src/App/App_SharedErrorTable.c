...
struct ErrorTable *App_SharedErrorTable_Create(void)
{
    ...
    INIT_ERROR(GSM_NON_CRITICAL_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ, GSM, NON_CRITICAL_ERROR);
    INIT_ERROR(GSM_NON_CRITICAL_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1KHZ, GSM, NON_CRITICAL_ERROR);
    INIT_ERROR(GSM_NON_CRITICAL_STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANRX, GSM, NON_CRITICAL_ERROR);
    INIT_ERROR(GSM_NON_CRITICAL_STACK_WATERMARK_ABOVE_THRESHOLD_TASKCANTX, GSM, NON_CRITICAL_ERROR);
    INIT_ERROR(GSM_NON_CRITICAL_WATCHDOG_TIMEOUT, GSM, NON_CRITICAL_ERROR);

    INIT_ERROR(BMS_AIR_SHUTDOWN_CHARGER_DISCONNECTED_IN_CHARGE_STATE, BMS, AIR_SHUTDOWN_ERROR);
    INIT_ERROR(BMS_AIR_SHUTDOWN_CELL_OVERVOLTAGE_FAULT, BMS, AIR_SHUTDOWN_ERROR);
    INIT_ERROR(BMS_AIR_SHUTDOWN_CELL_UNDERVOLTAGE_FAULT, BMS, AIR_SHUTDOWN_ERROR);
    INIT_ERROR(BMS_AIR_SHUTDOWN_HAS_PEC_FAULT, BMS, AIR_SHUTDOWN_ERROR);
    INIT_ERROR(BMS_AIR_SHUTDOWN_CELL_UNDERTEMP_FAULT, BMS, AIR_SHUTDOWN_ERROR);
    INIT_ERROR(BMS_AIR_SHUTDOWN_CELL_OVERTEMP_FAULT, BMS, AIR_SHUTDOWN_ERROR);
