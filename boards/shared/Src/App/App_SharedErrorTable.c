...
struct ErrorTable *App_SharedErrorTable_Create(void)
{
    ...
    INIT_ERROR(BMS_NON_CRITICAL_AVERAGE_CELL_TEMP_OUT_OF_RANGE, BMS, NON_CRITICAL_ERROR);
    INIT_ERROR(BMS_NON_CRITICAL_PACK_VOLTAGE_OUT_OF_RANGE, BMS, NON_CRITICAL_ERROR);
    INIT_ERROR(BMS_NON_CRITICAL_AVERAGE_CELL_VOLTAGE_OUT_OF_RANGE, BMS, NON_CRITICAL_ERROR);
    ...
    INIT_ERROR(BMS_AIR_SHUTDOWN_MIN_CELL_TEMP_OUT_OF_RANGE, BMS, AIR_SHUTDOWN_ERROR);
    INIT_ERROR(BMS_AIR_SHUTDOWN_MAX_CELL_TEMP_OUT_OF_RANGE, BMS, AIR_SHUTDOWN_ERROR);
