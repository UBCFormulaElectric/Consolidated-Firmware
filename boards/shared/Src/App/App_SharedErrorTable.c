...
struct ErrorTable *App_SharedErrorTable_Create(void)
{
    ...
    INIT_ERROR(BMS_NON_CRITICAL_MIN_CELL_TEMP_OUT_OF_RANGE, BMS, NON_CRITICAL_ERROR);
    INIT_ERROR(BMS_NON_CRITICAL_MAX_CELL_TEMP_OUT_OF_RANGE, BMS, NON_CRITICAL_ERROR);
