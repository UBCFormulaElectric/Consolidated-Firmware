...
struct ErrorTable *App_SharedErrorTable_Create(void)
{
    ...
    INIT_ERROR(FSM_NON_CRITICAL_BRAKE_FRONT_PRESSURE_OUT_OF_RANGE, FSM, NON_CRITICAL_ERROR);
    INIT_ERROR(FSM_NON_CRITICAL_BRAKE_REAR_PRESSURE_OUT_OF_RANGE, FSM, NON_CRITICAL_ERROR);
    INIT_ERROR(FSM_NON_CRITICAL_BRAKE_PRESSURE_OPEN_OCSC, FSM, NON_CRITICAL_ERROR);
    ...
    INIT_ERROR(FSM_MOTOR_SHUTDOWN_PAPPS_OCSC_IS_ACTIVE, FSM, MOTOR_SHUTDOWN_ERROR);
    INIT_ERROR(FSM_MOTOR_SHUTDOWN_SAPPS_OCSC_IS_ACTIVE, FSM, MOTOR_SHUTDOWN_ERROR);
    ...
    INIT_ERROR(FSM_MOTOR_SHUTDOWN_BRAKE_ACC_DISAGREEMENT, FSM, MOTOR_SHUTDOWN_ERROR);
