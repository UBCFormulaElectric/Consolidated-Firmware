...
//
// static void
//    Io_ProcessBmsMotorShutdownErrorMsg(struct ErrorTable *error_table, struct CanMsgs_bms_motor_shutdown_errors_t
//    *data)
//{
...
//
// static void
//    Io_ProcessDcmMotorShutdownErrorMsg(struct ErrorTable *error_table, struct CanMsgs_dcm_motor_shutdown_errors_t
//    *data)
//{
...
//
// static void
//    Io_ProcessDimMotorShutdownErrorMsg(struct ErrorTable *error_table, struct CanMsgs_dim_motor_shutdown_errors_t
//    *data)
//{
...
//
// static void
//    Io_ProcessFsmMotorShutdownErrorMsg(struct ErrorTable *error_table, struct CanMsgs_fsm_motor_shutdown_errors_t
//    *data)
//{
...
//    SET_ERROR(error_table, FSM_MOTOR_SHUTDOWN_TORQUE_PLAUSIBILITY_CHECK_FAILED,
//    data->torque_plausibility_check_failed);
//}
//
// static void
//    Io_ProcessPdmMotorShutdownErrorMsg(struct ErrorTable *error_table, struct CanMsgs_pdm_motor_shutdown_errors_t
//    *data)
//{
