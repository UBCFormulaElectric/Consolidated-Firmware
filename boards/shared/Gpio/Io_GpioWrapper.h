/**
 * @brief Wrappers for STM32 HAL GPIO driver
 */
#ifndef IO_GPIO_WRAPPER_H
#define IO_GPIO_WRAPPER_H
 ...
 *
 *        When we write `Io_GpioWrapper_GPIO_WritePin(GPIOA, GPIO_PIN_0,
 * FAN_ON)`, it is now much more clear that a fan is being turned on.
