 ...
 * @param f_x0 The previous value of f(x) used to approximate the value of the
 * current trapezoid
 * @param f_x1 The current value of f(x) used to approximate the value of the
 * current trapezoid
 * @param d_x The uniform delta-x of each trapezoid
 */
static inline void App_SharedProcessing_TrapezoidalRule(float *integral,
                                                        float *f_prev,
                                                        float f_curr,
                                                        float d_x) {
 ...
 */
float App_SharedProcessing_LinearDerating(float x, float max_y,
                                          float roll_off_x, float max_x);
