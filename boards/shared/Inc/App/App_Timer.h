 ...
 * TIMER_STATE_EXPIRED: Timer ran, and has completed its duration. This is typically when your code will decide to do something.
 * @param timer The timer in question
...
/**
 * Get the elapsed time since timer started, in milliseconds. Note that if timer is TIMER_STATE_IDLE, the elapsed time is zero,
 * and if the timer is TIMER_STATE_EXPIRED, the elapsed time is the timer's duration.
 * @param timer The timer in question
 * @return Elapsed time
 */
