...
#define TRC_CA9_MPCORE_PRIVCTR_PERIOD_REG \
    (*(volatile uint32_t                  \
           *)(TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS + TRC_CA9_MPCORE_PRIVATE_MEMORY_OFFSET + 0x00))
#define TRC_CA9_MPCORE_PRIVCTR_COUNTER_REG \
    (*(volatile uint32_t                   \
           *)(TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS + TRC_CA9_MPCORE_PRIVATE_MEMORY_OFFSET + 0x04))
#define TRC_CA9_MPCORE_PRIVCTR_CONTROL_REG \
    (*(volatile uint32_t                   \
           *)(TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS + TRC_CA9_MPCORE_PRIVATE_MEMORY_OFFSET + 0x08))
...
/****************************************************************************************
NOTE: The private timer ticks with a very high frequency (half the core-clock
usually), depending on the prescaler used. If a low prescaler is used, the
number of HW ticks between the trace events gets large, and thereby inefficient
to store (sometimes extra events are needed). To improve efficiency, you may use
the TRC_HWTC_DIVISOR as an additional prescaler.
*****************************************************************************************/
#define TRC_HWTC_DIVISOR 1
...
#if !(                                                       \
    defined(TRC_HWTC_TYPE) && defined(TRC_HWTC_COUNT) &&     \
