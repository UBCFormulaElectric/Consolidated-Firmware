 ...
 */
#ifndef IO_HEARTBEAT_DRIVER
#define IO_HEARTBEAT_DRIVER
 ...
 */
void Io_HeartbeatDriver_BroadcastHeartbeat(
 ...
 */
void Io_HeartbeatDriver_ReceiveHeartbeat(PcbHeartbeatEncoding_Enum board);
 ...
 *        PCBs.
 */
void Io_HeartbeatDriver_CheckHeartbeatTimeout(uint8_t heartbeats_to_check);
