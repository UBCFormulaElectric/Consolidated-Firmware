/**
 * @brief Callback functions for hard-fault exceptions
 * @note  This library is inspired by the example code here:
 *        https://www.freertos.org/Debugging-Hard-Faults-On-Cortex-M-Microcontrollers.html
 */
#ifndef IO_HARD_FAULT_HANDLER_H
#define IO_HARD_FAULT_HANDLER_H
...
// Io_HardFaultHandler_LogInformation().
//
// Note: The MSP/PSP architecture is specific to the Cortex-M microcontroller
//       family.
#define Io_HardFaultHandler_HandleHardFault()                      \
    __asm volatile(" tst lr, #4                                \n" \
                   " ite eq                                    \n" \
                   " mrseq r0, msp                             \n" \
                   " mrsne r0, psp                             \n" \
                   " ldr r1, [r0, #24]                         \n" \
                   " b Io_HardFaultHandler_LogInformation   \n");
 ...
 *        possible.
 */
void Io_HardFaultHandler_Init(void);
 ...
 *        occurred.
 */
void Io_HardFaultHandler_LogInformation(uint32_t *fault_stack);

#endif /* IO_HARD_FAULT_HANDLER_H */
