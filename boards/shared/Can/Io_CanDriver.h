/**
 * @brief CAN driver built on top of STM32 HAL library
 */
#ifndef IO_CAN_DRIVER_H
#define IO_CAN_DRIVER_H
...
#define SHAREDCAN_SEND_CAN_MSG(MSG_NAME, MSG_STRUCT_PTR) \
    ...
    int ___size = CanMsgs_##MSG_NAME##_pack(&___data[0], MSG_STRUCT_PTR, \
                                            CAN_PAYLOAD_MAX_NUM_BYTES); \
    Io_CanDriver_TransmitDataCan(CANMSGS_##MSG_NAME##_FRAME_ID, \
                              (size_t)___size, \
                              &___data[0])
