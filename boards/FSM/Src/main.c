...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, STATUS_R_Pin|STATUS_G_Pin|STATUS_B_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PB0 PB13 PB15 PB6 
                           PB7 */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_13|GPIO_PIN_15|GPIO_PIN_6 
                          |GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : UNUSED_GPIO_2_Pin UNUSED_GPIO_3_Pin UNUSED_GPIO_4_Pin UNUSED_GPIO_5_Pin 
                           UNUSED_GPIO_6_Pin UNUSED_GPIO_7_Pin UNUSED_GPIO_8_Pin */
  GPIO_InitStruct.Pin = UNUSED_GPIO_2_Pin|UNUSED_GPIO_3_Pin|UNUSED_GPIO_4_Pin|UNUSED_GPIO_5_Pin 
                          |UNUSED_GPIO_6_Pin|UNUSED_GPIO_7_Pin|UNUSED_GPIO_8_Pin;
