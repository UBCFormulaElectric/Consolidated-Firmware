...
int main(void) {
  ...
  papps_and_sapps = App_AcceleratorPedals_Create(
      Io_AcceleratorPedals_GetPapps, Io_AcceleratorPedals_PappsOCSC,
      Io_AcceleratorPedals_GetSapps, Io_AcceleratorPedals_SappsOCSC);
  ...
  coolant =
      App_Coolant_Create(Io_FlowMeter_GetFlowRate, Io_Coolant_GetTemperatureA,
                         Io_Coolant_GetTemperatureB, Io_Coolant_GetPressureA,
                         Io_Coolant_GetPressureB);

  steering = App_Steering_Create(Io_SteeringAngleSensor_GetAngleDegree,
                                 Io_SteeringSensorOCSC);

  Io_WheelSpeedSensors_Init(&htim12, &htim12);
  wheels = App_Wheels_Create(Io_WheelSpeedSensors_GetLeftSpeedKph,
                             Io_WheelSpeedSensors_GetRightSpeedKph);
