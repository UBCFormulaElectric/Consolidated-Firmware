...
void HAL_ADC_MspInit(ADC_HandleTypeDef *hadc)
{
    ...
    if (hadc->Instance == ADC2)
    {
        ...
        PA6     ------> ADC2_IN3
        */
        GPIO_InitStruct.Pin  = APPS_POT_Pin | BRAKE_PRESS_BUFF_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef *hadc)
{
    if (hadc->Instance == ADC2)
    {
        ...
        PA6     ------> ADC2_IN3
        */
        HAL_GPIO_DeInit(GPIOA, APPS_POT_Pin | BRAKE_PRESS_BUFF_Pin);
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef *htim_ic)
{
    ...
    if (htim_ic->Instance == TIM4)
    {
        ...
        PA12     ------> TIM4_CH2
        */
        GPIO_InitStruct.Pin       = FLOW1_BUFF_Pin;
        GPIO_InitStruct.Mode      = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull      = GPIO_PULLDOWN;
        GPIO_InitStruct.Speed     = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF10_TIM4;
        HAL_GPIO_Init(FLOW1_BUFF_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef *htim_ic)
{
    if (htim_ic->Instance == TIM4)
    {
        ...
        PA12     ------> TIM4_CH2
        */
        HAL_GPIO_DeInit(FLOW1_BUFF_GPIO_Port, FLOW1_BUFF_Pin);
