...

{
    ...
    struct SignalCallback papps_callback = {
        .entry_high_duration_ms = PAPPS_ENTRY_HIGH_MS,
        .exit_high_duration_ms  = PAPPS_EXIT_HIGH_MS,
    ...
    struct SignalCallback sapps_callback = {
        .entry_high_duration_ms = SAPPS_ENTRY_HIGH_MS,
        .exit_high_duration_ms  = SAPPS_EXIT_HIGH_MS,
    ...
    struct SignalCallback apps_callback = {
        .entry_high_duration_ms = APPS_ENTRY_HIGH_MS,
        .exit_high_duration_ms  = APPS_EXIT_HIGH_MS,
    ...
    struct SignalCallback apps_and_brake_callback = {
        .entry_high_duration_ms = APPS_AND_BRAKE_ENTRY_HIGH_MS,
        .exit_high_duration_ms  = APPS_AND_BRAKE_EXIT_HIGH_MS,
