...
struct FsmWorld *App_FsmWorld_Create(
    ...
    struct AcceleratorPedals *const papps_and_sapps, struct Brake *const brake,
    struct Coolant *const coolant, struct Steering *const steering,
...
void App_FsmWorld_Destroy(struct FsmWorld *world) { free(world); }
