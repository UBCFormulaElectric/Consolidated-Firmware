    ...
    bool (*is_brake_actuated)(void))
{
    ...
    brake->front_pressure_in_range_check = App_InRangeCheck_Create(get_front_pressure_psi,
        MIN_BRAKE_PRESSURE_PSI,
        MAX_BRAKE_PRESSURE_PSI
    );
    brake->rear_pressure_in_range_check = App_InRangeCheck_Create(get_rear_pressure_psi,
          MIN_BRAKE_PRESSURE_PSI,
          MAX_BRAKE_PRESSURE_PSI
    );
