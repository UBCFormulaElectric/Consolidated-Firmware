...
void HAL_ADC_MspInit(ADC_HandleTypeDef *hadc) {
  ...
  if (hadc->Instance == ADC1) {
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = COOLANT_PRESSURE1_3V3_Pin | APPS2_3V3_Pin |
                          APPS1_3V3_Pin | COOLANT_PRESSURE2_3V3_Pin |
                          COOLANT_TEMP103V_Pin | COOLANT_TEMP2_3V3_Pin |
                          STEERING_ANGLE_3V3_Pin | BPS_F_3V3_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef *hadc) {
  if (hadc->Instance == ADC1) {
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, COOLANT_PRESSURE1_3V3_Pin | APPS2_3V3_Pin |
                               APPS1_3V3_Pin | COOLANT_PRESSURE2_3V3_Pin |
                               COOLANT_TEMP103V_Pin | COOLANT_TEMP2_3V3_Pin |
                               STEERING_ANGLE_3V3_Pin | BPS_F_3V3_Pin);
