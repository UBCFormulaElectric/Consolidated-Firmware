 ...
 * @param get_temperature_A Function which returns the temperature at point A of
 * the coolant
 * @param get_temperature_B Function which returns the temperature at point B of
 * the coolant
 * @param get_pressure_A Function which returns the pressure at point A of the
 * coolant
 * @param get_pressure_B Function which returns the pressure at point B of the
 * coolant
