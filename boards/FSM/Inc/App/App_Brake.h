 ...
 * @param front_pressure_sensor_ocsc A function that returns whether or not the front pressure sensor is open or short circuit
 * @param get_rear_pressure_psi A function that returns the brake pressure in psi from the secondary sensor
 * @param rear_pressure_sensor_ocsc A function that returns whether or not the rear pressure sensor is open or short circuit
 * @param get_pedal_travel A function that returns the brake pedal angle in radians
 * @param pedal_travel_sensor_ocsc A function that returns whether or not the pedal travel sensor is open or short circuit
