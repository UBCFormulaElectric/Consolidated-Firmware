 ...
 * @param encoder_resolution The resolution for the encoder corresponding to the
 * given accelerator pedal
 * @param encoder_max_pressed_value The experimentally determined encoder
 * counter value corresponding to the accelerator pedal's high-end dead-zone
 * boundary
 ...
 * from
 * @return The pedal percentage for the given accelerator pedal
 */
