...
#define TIM4_PRESCALER \
    (TIMx_FREQUENCY / TIM4_AUTO_RELOAD_REG / TIM4_PWM_MINIMUM_FREQUENCY) - 1
...
#define TIM16_PRESCALER \
    (TIMx_FREQUENCY / TIM16_AUTO_RELOAD_REG / TIM16_PWM_MINIMUM_FREQUENCY) - 1
#define TIM17_PRESCALER \
    (TIMx_FREQUENCY / TIM17_AUTO_RELOAD_REG / TIM17_PWM_MINIMUM_FREQUENCY) - 1
...
#define SECONDARY_APPS_Z_Pin GPIO_PIN_2
#define SECONDARY_APPS_Z_GPIO_Port GPIOA
...
#define PRIMARY_APPS_ALARM_Pin GPIO_PIN_15
#define PRIMARY_APPS_ALARM_GPIO_Port GPIOB
...
#define PRIMARY_APPS_Z_Pin GPIO_PIN_10
