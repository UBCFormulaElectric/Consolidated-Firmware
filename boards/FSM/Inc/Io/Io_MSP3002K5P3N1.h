...
/**
 * Check if the pressure from MSP-300-2K5-P-3-N-1 exceeds the brake pressure threshold. If the pressure exceeds threshold, the brake is said to be actuated.
