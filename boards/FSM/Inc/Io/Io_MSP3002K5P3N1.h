 ...
 * or short circuit state. If the output voltage exceeds the open circuit
 * threshold or goes below the short circuit threshold, the brake pressure
 * sensor is said to be open/short circuited
