...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, INVERTER_L_RUN_Pin|INVERTER_R_RUN_Pin|BUZZER_EN_Pin|BRAKE_LIGHT_EN_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = UNUSED_GPIO1_Pin|UNUSED_GPIO2_Pin|UNUSED_GPIO3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : UNUSED_GPIO4_Pin UNUSED_GPIO5_Pin UNUSED_GPIO6_Pin */
  GPIO_InitStruct.Pin = UNUSED_GPIO4_Pin|UNUSED_GPIO5_Pin|UNUSED_GPIO6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : INVERTER_L_RUN_Pin INVERTER_R_RUN_Pin BUZZER_EN_Pin BRAKE_LIGHT_EN_Pin */
  GPIO_InitStruct.Pin = INVERTER_L_RUN_Pin|INVERTER_R_RUN_Pin|BUZZER_EN_Pin|BRAKE_LIGHT_EN_Pin;
