...
{
    float slip_ratio_left  = ComputeSlip(inputs->motor_speed_left_rpm, inputs->motor_speed_left_rpm);
    float slip_ratio_right = ComputeSlip(inputs->motor_speed_right_rpm, inputs->motor_speed_right_rpm);
