...
void App_SbgEllipseN_Broadcast()
{
    ...
    App_CanTx_DCM_SbgEllipseStatus_GeneralStatusBitmask_Set(general_status);
    App_CanTx_DCM_SbgEllipseStatus_ComStatusBitmask_Set(com_status);

    // Time msg
    const uint32_t timestamp_us = App_SbgEllipseN_GetTimestampUs();
    App_CanTx_DCM_SbgEllipseTime_Timestamp_Set(timestamp_us);
    ...
    App_CanTx_DCM_SbgEllipseAcceleration_Forward_Set(forward_accel);
    App_CanTx_DCM_SbgEllipseAcceleration_Lateral_Set(lateral_accel);
    App_CanTx_DCM_SbgEllipseAcceleration_Vertical_Set(vertical_accel);
    ...
    App_CanTx_DCM_SbgEllipseAngularVelocity_Roll_Set((int)ang_vel_roll);
    App_CanTx_DCM_SbgEllipseAngularVelocity_Pitch_Set((int)ang_vel_pitch);
    App_CanTx_DCM_SbgEllipseAngularVelocity_Yaw_Set((int)ang_vel_yaw);
    ...
    App_CanTx_DCM_SbgEllipseEulerAngles_Roll_Set(euler_roll);
    App_CanTx_DCM_SbgEllipseEulerAngles_Pitch_Set(euler_pitch);
    App_CanTx_DCM_SbgEllipseEulerAngles_Yaw_Set(euler_yaw);
}
