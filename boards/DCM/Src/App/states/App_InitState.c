...
static void InitStateRunOnEntry(struct StateMachine *const state_machine)
{
    ...
    uint8_t switch_position = App_CanRx_DIM_SWITCHES_GetSignal_START_SWITCH(can_rx_interface);
...
static void InitStateRunOnTick100Hz(struct StateMachine *const state_machine)
{
    ...
    uint8_t start_switch_position = App_CanRx_DIM_SWITCHES_GetSignal_START_SWITCH(can_rx_interface);
