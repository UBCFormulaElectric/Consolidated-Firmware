...
static void DriveStateRunOnEntry(struct StateMachine *const state_machine)
{
    ...
    // TODO check -> App_CanTx_SetPeriodicSignal_STATE(can_tx_interface, CANMSGS_DCM_STATE_MACHINE_STATE_DRIVE_CHOICE);
...
//        struct DcmWorld *world = App_SharedStateMachine_GetWorld(state_machine);
        ...
        if (!App_IsStartSwitchOn()) // TODO check-> (!App_IsStartSwitchOn(can_rx))
        {
