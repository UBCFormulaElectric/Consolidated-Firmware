...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB13     ------> ADC1_IN13 
    */
    GPIO_InitStruct.Pin = UNUSED_ANALOG_IN1_Pin|UNUSED_ANALOG_IN2_Pin|UNUSED_ANALOG_IN3_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB13     ------> ADC1_IN13 
    */
    HAL_GPIO_DeInit(GPIOA, UNUSED_ANALOG_IN1_Pin|UNUSED_ANALOG_IN2_Pin|UNUSED_ANALOG_IN3_Pin);
