...
/**
 * IMPORTANT! LV (+12 V) to the PM100DZ inverters must only be provided once the AIRs are closed.
 * Otherwise, the inverters will enter the fault state on power-up.
 */

/**
 * Allocate and initialize an InverterSwitches struct
 * @param turn_on_right_inverter A function that can be called to enable LV to the right inverter
 * @param turn_off_right_inverter A function that can be called to disable LV the right inverter
 * @param turn_on_left_inverter A function that can be called to enable LV to the left inverter
 * @param turn_off_left_inverter A function that can be called to disable LV to the left inverter
 ...
 * @param inverter_switches The InverterSwitches struct to check the status of the switch
