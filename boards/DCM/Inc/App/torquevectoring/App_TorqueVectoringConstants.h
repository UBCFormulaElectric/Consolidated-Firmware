...
#define POWER_LIMIT_CAR_kW 10.0f               // max power we can use by FSAE rules redefined to 10 kw for testing purposes
#define MOTOR_TORQUE_LIMIT_Nm 11.0f            //max torque redefined form 90 to 11 for testing purposes
