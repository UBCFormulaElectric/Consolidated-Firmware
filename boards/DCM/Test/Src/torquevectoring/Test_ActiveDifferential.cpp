...
TEST_F(ActiveDifferentialTest, max_power){
    ...
    float delta_t1 = TRACK_WIDTH_mm* tanf(wheel_angle_t1)/(2 * WHEELBASE_mm);
    ...
    if(max_torque_t1 > MOTOR_TORQUE_LIMIT_Nm){
        float sigma_t1 = max_torque_t1/MOTOR_TORQUE_LIMIT_Nm;
...
TEST_F(ActiveDifferentialTest, turning_right){
    ...
    float delta_t3 = TRACK_WIDTH_mm* tanf(wheel_angle_t3)/(2 * WHEELBASE_mm);
    ...
    if(max_torque_t3 > MOTOR_TORQUE_LIMIT_Nm){
        float sigma_t3 = max_torque_t3/MOTOR_TORQUE_LIMIT_Nm;
...
TEST_F(ActiveDifferentialTest, turning_left){
    ...
    float delta_t4 = TRACK_WIDTH_mm* tanf(wheel_angle_t4)/(2 * WHEELBASE_mm);
    ...
    if(max_torque_t4 > MOTOR_TORQUE_LIMIT_Nm){
        float sigma_t4 = max_torque_t4/MOTOR_TORQUE_LIMIT_Nm;
