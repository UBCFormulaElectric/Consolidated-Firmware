...
bool App_LoadSwitch_AreCurrentsInRange(struct LoadSwitch *load_switch) {
    ...
    if (App_LoadSwitch_InRangeCheck(load_switch->get_AUX1_current(), AUX1_MIN_CURRENT, AUX1_MAX_CURRENT) == 0 &&
        ...
        App_LoadSwitch_InRangeCheck(load_switch->get_LEFT_INVERTER_current(), LEFT_INVERTER_MIN_CURRENT, LEFT_INVERTER_MAX_CURRENT) == 0 &&
        App_LoadSwitch_InRangeCheck(load_switch->get_RIGHT_INVERTER_current(), RIGHT_INVERTER_MIN_CURRENT, RIGHT_INVERTER_MAX_CURRENT) == 0 &&
        App_LoadSwitch_InRangeCheck(load_switch->get_ENERGY_METER_current(), ENERGY_METER_MIN_CURRENT, ENERGY_METER_MAX_CURRENT) == 0 &&
        App_LoadSwitch_InRangeCheck(load_switch->get_CAN_current(), CAN_MIN_CURRENT, CAN_MAX_CURRENT) == 0 &&
        App_LoadSwitch_InRangeCheck(load_switch->get_AIR_SHUTDOWN_current(), AIR_SHUTDOWN_MIN_CURRENT, AIR_SHUTDOWN_MAX_CURRENT) == 0)
        return true;
    return false;
}
