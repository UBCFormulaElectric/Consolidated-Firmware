...
class PdmStateMachineTest : public BaseStateMachineTest
{
  protected:
    void SetUp() override
    {
        ...
        low_voltage_battery = App_LowVoltageBattery_Create(do_low_voltage_battery_have_charge_fault, do_low_voltage_battery_have_boost_controller_fault);

        clock = App_SharedClock_Create();

        state_machine = App_SharedStateMachine_Create(world, App_GetInitState());

        efuse1 = App_Efuse_Create(EFUSE_CHANNEL_AIR, EFUSE_CHANNEL_LVPWR, EFUSE1_AIR_MIN_CURRENT, EFUSE1_AIR_MAX_CURRENT, EFUSE1_LV_POWER_MIN_CURRENT, EFUSE1_LV_POWER_MAX_CURRENT, Efuse1MaxAttempts);
        efuse2 = App_Efuse_Create(EFUSE_CHANNEL_EMETER, EFUSE_CHANNEL_AUX, EFUSE2_AUX_MIN_CURRENT, EFUSE2_AUX_MAX_CURRENT, EFUSE2_EMETER_MIN_CURRENT, EFUSE2_AUX_MAX_CURRENT, Efuse2MaxAttempts);
        efuse3 = App_Efuse_Create(EFUSE_CHANNEL_DI_LHS, EFUSE_CHANNEL_DI_RHS, EFUSE3_LEFT_INVERTER_MIN_CURRENT, EFUSE3_LEFT_INVERTER_MAX_CURRENT, EFUSE3_RIGHT_INVERTER_MIN_CURRENT, EFUSE3_RIGHT_INVERTER_MAX_CURRENT, Efuse3MaxAttempts);
        efuse4 = App_Efuse_Create(EFUSE_CHANNEL_DRS, EFUSE_CHANNEL_FAN, EFUSE4_DRS_MIN_CURRENT, EFUSE4_DRS_MAX_CURRENT, EFUSE4_FAN_MIN_CURRENT, EFUSE4_FAN_MAX_CURRENT, Efuse4MaxAttempts);
