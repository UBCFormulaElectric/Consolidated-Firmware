...
void Rail_Voltages_CANTX(struct RailMonitoring *rail_monitor)
{
    ...
    App_CanTx_PDM_24V_ACC_Voltage_Set(App_RailMonitoring_Get_24VAccumulatorVoltage(rail_monitor));
    ...
    App_CanTx_PDM_22V_AUX_Voltage_Set(App_RailMonitoring_Get_22VAuxiliaryVoltage(rail_monitor));
