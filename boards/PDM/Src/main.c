...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, PIN_DI_R_Pin|PIN_DI_L_Pin|PIN_AIR_SHDN_Pin|PIN_GLV_Pin 
                          |PIN_EM_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, CSB_DI_L_DI_R_Pin|CSB_GLV_AIR_SHDN_Pin|CSB_AUX1_AUX2_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : CUR_SYNC_DI_L_DI_R_Pin CUR_SYNC_GLV_AIR_SHDN_Pin CUR_SYNC_EM_PUMP_Pin */
  GPIO_InitStruct.Pin = CUR_SYNC_DI_L_DI_R_Pin|CUR_SYNC_GLV_AIR_SHDN_Pin|CUR_SYNC_EM_PUMP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PIN_DI_R_Pin PIN_DI_L_Pin PIN_AIR_SHDN_Pin PIN_GLV_Pin 
                           PIN_EM_Pin */
  GPIO_InitStruct.Pin = PIN_DI_R_Pin|PIN_DI_L_Pin|PIN_AIR_SHDN_Pin|PIN_GLV_Pin 
                          |PIN_EM_Pin;
  ...
  /*Configure GPIO pins : CSB_DI_L_DI_R_Pin CSB_GLV_AIR_SHDN_Pin CSB_AUX1_AUX2_Pin */
  GPIO_InitStruct.Pin = CSB_DI_L_DI_R_Pin|CSB_GLV_AIR_SHDN_Pin|CSB_AUX1_AUX2_Pin;
