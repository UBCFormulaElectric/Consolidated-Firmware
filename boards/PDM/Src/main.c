...
int main(void)
{
    ...
    efuse1 = App_Efuse_Create(
        EFUSE_CHANNEL_AIR, EFUSE_CHANNEL_LVPWR, Io_Efuse_SetChannel, Io_Efuse_IsChannelEnabled,
        Io_Efuse_GetChannelCurrent, Io_Efuse_StandbyReset, EFUSE1_AIR_MIN_CURRENT, EFUSE1_AIR_MAX_CURRENT,
        EFUSE1_LV_POWER_MIN_CURRENT, EFUSE1_LV_POWER_MAX_CURRENT, 3);
    efuse2 = App_Efuse_Create(
        EFUSE_CHANNEL_EMETER, EFUSE_CHANNEL_AUX, Io_Efuse_SetChannel, Io_Efuse_IsChannelEnabled,
        Io_Efuse_GetChannelCurrent, Io_Efuse_StandbyReset, EFUSE2_AUX_MIN_CURRENT, EFUSE2_AUX_MAX_CURRENT,
        EFUSE2_EMETER_MIN_CURRENT, EFUSE2_AUX_MAX_CURRENT, 0);
    efuse3 = App_Efuse_Create(
        EFUSE_CHANNEL_DI_LHS, EFUSE_CHANNEL_DI_RHS, Io_Efuse_SetChannel, Io_Efuse_IsChannelEnabled,
        Io_Efuse_GetChannelCurrent, Io_Efuse_StandbyReset, EFUSE3_LEFT_INVERTER_MIN_CURRENT,
    ...
    efuse4 = App_Efuse_Create(
        EFUSE_CHANNEL_DRS, EFUSE_CHANNEL_FAN, Io_Efuse_SetChannel, Io_Efuse_IsChannelEnabled,
        Io_Efuse_GetChannelCurrent, Io_Efuse_StandbyReset, EFUSE4_DRS_MIN_CURRENT, EFUSE4_DRS_MAX_CURRENT,
        EFUSE4_FAN_MIN_CURRENT, EFUSE4_FAN_MAX_CURRENT, 3);
