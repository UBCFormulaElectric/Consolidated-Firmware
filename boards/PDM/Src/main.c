...
int main(void) {
  ...
  _24v_aux_voltage_in_range_check =
      App_InRangeCheck_Create(Io_VoltageSense_Get24vAuxVoltage,
                              _24V_AUX_MIN_VOLTAGE, _24V_AUX_MAX_VOLTAGE);

  _24v_acc_voltage_in_range_check =
      App_InRangeCheck_Create(Io_VoltageSense_Get24vAccVoltage,
  ...
  world = App_PdmWorld_Create(
      ...
      air_shutdown_current_in_range_check, heartbeat_monitor, rgb_led_sequence,
      low_voltage_battery, clock);
...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(
      GPIOA, EN_DI_RHS_Pin | FR_STBY_DIS_Pin | EN_DI_LHS_Pin | EN_FAN_Pin,
      GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB,
                    LED_Pin | EN_AIR_Pin | FR_STBY_AIR_LVPWR_Pin |
                        EN_LVPWR_Pin | EN_EMETER_Pin,
                    GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(
      GPIOC,
      FR_STBY_EMETER_AUX_Pin | EN_AUX_Pin | EN_DRS_Pin | FR_STBY_DRS_FAN_Pin,
      GPIO_PIN_RESET);

  /*Configure GPIO pins : EN_DI_RHS_Pin FR_STBY_DIS_Pin EN_DI_LHS_Pin EN_FAN_Pin
   */
  GPIO_InitStruct.Pin =
      EN_DI_RHS_Pin | FR_STBY_DIS_Pin | EN_DI_LHS_Pin | EN_FAN_Pin;
  ...
  /*Configure GPIO pins : LED_Pin EN_AIR_Pin FR_STBY_AIR_LVPWR_Pin EN_LVPWR_Pin
                           EN_EMETER_Pin */
  GPIO_InitStruct.Pin = LED_Pin | EN_AIR_Pin | FR_STBY_AIR_LVPWR_Pin |
                        EN_LVPWR_Pin | EN_EMETER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : FR_STBY_EMETER_AUX_Pin EN_AUX_Pin EN_DRS_Pin
   * FR_STBY_DRS_FAN_Pin */
  GPIO_InitStruct.Pin =
      FR_STBY_EMETER_AUX_Pin | EN_AUX_Pin | EN_DRS_Pin | FR_STBY_DRS_FAN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
