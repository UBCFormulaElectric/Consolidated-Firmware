...
int main(void)
{
    ...
    _24v_boost_out_voltage_in_range_check = App_InRangeCheck_Create(
        Io_VoltageSense_Get24vBoostOutVoltage, _24V_BOOST_OUT_MIN_VOLTAGE,
    ...
    back_left_inverter_current_in_range_check = App_InRangeCheck_Create(
        Io_CurrentSense_GetBackLeftInverterCurrent,
        BACK_LEFT_INVERTER_MIN_CURRENT, BACK_LEFT_INVERTER_MAX_CURRENT);

    back_right_inverter_current_in_range_check = App_InRangeCheck_Create(
        Io_CurrentSense_GetBackRightInverterCurrent,
    ...
    front_left_inverter_current_in_range_check = App_InRangeCheck_Create(
        Io_CurrentSense_GetFrontLeftInverterCurrent,
    ...
    front_right_inverter_current_in_range_check = App_InRangeCheck_Create(
        Io_CurrentSense_GetFrontRightInverterCurrent,
    ...
    world = App_PdmWorld_Create(
        ...
        air_shutdown_current_in_range_check, can_current_in_range_check,
        ...
        front_right_inverter_current_in_range_check, heartbeat_monitor,
