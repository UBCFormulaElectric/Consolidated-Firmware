...
void Io_Efuse_22XS4200_configureEfuse(struct E_Fuse *e_fuse)
{
    ...
    Io_Efuse_22XS4200_WriteReg(
            SI_RETRY_0_ADDR, RETRY_0_CONFIG, e_fuse);
    Io_Efuse_22XS4200_WriteReg(
            SI_CONFR_0_ADDR, CONFR_0_CONFIG, e_fuse);
    Io_Efuse_22XS4200_WriteReg(SI_OCR_0_ADDR, OCR_0_CONFIG, e_fuse);

    // Channel 1 config registers
    Io_Efuse_22XS4200_WriteReg(
            SI_RETRY_1_ADDR, RETRY_1_CONFIG, e_fuse);
    Io_Efuse_22XS4200_WriteReg(
            SI_CONFR_1_ADDR, CONFR_1_CONFIG, e_fuse);
