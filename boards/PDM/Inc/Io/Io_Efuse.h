 ...
 * off in the case of an overtemperature or overcurrent condition. To clear
 * these faults, a low pulse must be sent on the standby reset line.
 *
 * Note that each efuse IC has 2 channels, and delatching will affect them both.
 * We have 4 efuse ICS, with channels:
 * 1. Efuse 1: AIR and LVPWR
 * 2. Efuse 2: EMETER and AUX
 * 3. Efuse 3: DRS and FAN
 * 4. Efuse 4: DI_LHS and DI_RHS
 *
 * So be aware that, for example, a delatching faults on the AIR channel will
 * also delatch faults on the LVPWR line.
 *
