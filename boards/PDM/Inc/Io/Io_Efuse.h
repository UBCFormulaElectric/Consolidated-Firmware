...
/**
 * Checks if Channel_0 is enabled or not
 * @param io_efuse
...
/**
 * Checks if Channel_1 is enabled or not
 * @param io_efuse
 * @return true if enabled, false if not
 */
...
/**
 * Puts a current through the STBY_RST pin to attempt to reset the Efuse after a failure
 * @param io_efuse
 */
