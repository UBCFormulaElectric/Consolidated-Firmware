...
typedef enum
{
    ...
    ChannelConfigType_DirecControl_Disable =
        (1 << 5), //!< Direct Control Disable
    ChannelConfigType_OpenLoad_InOffState =
        (1 << 6), //!< Open Load Detection in Off-state
    ChannelConfigType_OpenLoad_InOnState =
        (1 << 7), //!< Open Load Detection in On-state
    ChannelConfigType_ShortCircuitDetection_Disable =
...
/**
 * DGets the value of the Efuse's Fault Register over SPI and updates the Efuse
