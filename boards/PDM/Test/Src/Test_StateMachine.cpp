...
class PdmStateMachineTest : public InRangeCheckTest
{
  protected:
    ...
    {
        InRangeCheckTest::TearDownInRangeCheck(vbat_voltage_in_range_check);
        InRangeCheckTest::TearDownInRangeCheck(_24v_aux_voltage_in_range_check);
        InRangeCheckTest::TearDownInRangeCheck(_24v_acc_voltage_in_range_check);
        InRangeCheckTest::TearDownInRangeCheck(aux1_current_in_range_check);
        InRangeCheckTest::TearDownInRangeCheck(aux2_current_in_range_check);
        InRangeCheckTest::TearDownInRangeCheck(
            left_inverter_current_in_range_check);
        InRangeCheckTest::TearDownInRangeCheck(
            right_inverter_current_in_range_check);
        InRangeCheckTest::TearDownInRangeCheck(
            energy_meter_current_in_range_check);
        InRangeCheckTest::TearDownInRangeCheck(can_current_in_range_check);
        InRangeCheckTest::TearDownInRangeCheck(
