...
FAKE_VOID_FUNC(Aux1ErrorCallback, struct InRangeCheck *);

FAKE_VALUE_FUNC(float, GetAux2Current);
FAKE_VOID_FUNC(Aux2ErrorCallback, struct InRangeCheck *);

FAKE_VALUE_FUNC(float, GetLeftInverterCurrent);
FAKE_VOID_FUNC(LeftInverterErrorCallback, struct InRangeCheck *);

FAKE_VALUE_FUNC(float, GetRightInverterCurrent);
FAKE_VOID_FUNC(RightInverterErrorCallback, struct InRangeCheck *);

FAKE_VALUE_FUNC(float, GetEnergyMeterCurrent);
FAKE_VOID_FUNC(EnergyMeterErrorCallback, struct InRangeCheck *);

FAKE_VALUE_FUNC(float, GetCanCurrent);
FAKE_VOID_FUNC(CanErrorCallback, struct InRangeCheck *);

FAKE_VALUE_FUNC(float, GetAirShutdownCurrent);
FAKE_VOID_FUNC(AirShutdownErrorCallback, struct InRangeCheck *);
