...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, BSPD_LED_Pin|PDM_R_Pin|PDM_G_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, DCM_B_Pin|DIM_G_Pin|DIM_B_Pin|PDM_RA3_Pin 
                          |DCM_G_Pin|PDM_B_Pin|FSM_G_Pin|BMS_B_Pin 
                          |SEG_DIMMING_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DCM_R_Pin|BMS_G_Pin|FSM_R_Pin|FSM_B_Pin 
                          |BMS_R_Pin|SEG_SRCK_Pin|SEG_SEROUT_Pin|SEG_RCK_Pin 
                          |IMD_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : REGEN_Pin DRIVE_MODE5_Pin DRIVE_MODE1_Pin TRAC_CTRL_Pin 
                           TORQ_VECT_Pin IGNTN_Pin */
  GPIO_InitStruct.Pin = REGEN_Pin|DRIVE_MODE5_Pin|DRIVE_MODE1_Pin|TRAC_CTRL_Pin 
                          |TORQ_VECT_Pin|IGNTN_Pin;
