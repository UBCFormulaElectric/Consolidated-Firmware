...
enum ErrorId
{
    ...
    DCM_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ = 1,
    FSM_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ = 2,
    PDM_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ = 3,
    DIM_STACK_WATERMARK_ABOVE_THRESHOLD_TASK1HZ = 4,
    BMS_CRITICAL_ERROR_DUMMY_CRITICAL_ERROR = 5,
    DCM_CRITICAL_ERROR_DUMMY_CRITICAL_ERROR = 6,
    FSM_CRITICAL_ERROR_DUMMY_CRITICAL_ERROR = 7,
    PDM_CRITICAL_ERROR_DUMMY_CRITICAL_ERROR = 8,
    DIM_CRITICAL_ERROR_DUMMY_CRITICAL_ERROR = 9,
    NUM_ERRORS, // Number of non-critical and critical errors combined
};
