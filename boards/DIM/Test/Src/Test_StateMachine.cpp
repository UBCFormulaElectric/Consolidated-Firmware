...
class DimStateMachineTest : public BaseStateMachineTest
{
  protected:
    void SetUp() override
    {
        ...
        aux_switch = App_BinarySwitch_Create(aux_switch_is_turned_on);
...
//        torque_vectoring_switch = App_BinarySwitch_Create(torque_vectoring_switch_is_turned_on);
        ...
        world = App_DimWorld_Create(
            ...
            aux_switch, bms_status_led, dcm_status_led, dim_status_led,
        ...
        RESET_FAKE(aux_switch_is_turned_on);
    ...
    void TearDown() override
    {
        ...
        TearDownObject(aux_switch, App_BinarySwitch_Destroy);
...
TEST_F(DimStateMachineTest, check_7_seg_displays_cycle_through_two_error_ids_in_drive_state)
{
    ...
    //    App_SharedErrorTable_SetError(error_table, (enum ErFAKE_VOID_FUNCrorId)(10), true);
...
TEST_F(DimStateMachineTest, check_aux_switch_is_broadcasted_over_can_in_drive_state)
{
    ...
    aux_switch_is_turned_on_fake.return_val = true;
    LetTimePass(state_machine, 10);
    //    ASSERT_EQ(
