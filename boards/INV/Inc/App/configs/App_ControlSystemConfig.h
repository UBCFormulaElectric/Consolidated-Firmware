...
#define MAX_INVERTER_CURRENT (30.0f) // 148.5f // Maximum inverter current (peak), in A
...
#define MAX_PHASE_VOLTAGE (207.8460969082653f) // Maximum inverter ac voltage (phase peak)
...
#define MAX_SWITCHING_FREQUENCY (12000) // Maximum settable switching frequency, in Hz
#define MIN_SWITCHING_FREQUENCY (4000)                       // Minimum settable switching frequency, in Hz
#define SAMPLE_FREQUENCY (20000) // Sampling frequency of sensors for control loop
#define D_GAIN (0.8706229594480495f / 500.0f)     // PI controller D axis gain
#define D_TIME_CONST (0.001777777777777778f) // PI controller D axis time constant
#define Q_GAIN (1.741245918896099f / 500.0f)      // PI controller Q axis gain
...
#define LOWER_ADAPTION_LIMIT (0.19f) // Lower adaption max current percentage limit
#define UPPER_ADAPTION_LIMIT (0.68f) // Upper adaption max current percentage limit
