...
void ImdTest::SetImdCondition(struct Imd *imd_to_set,
...
void ImdTest::SetPwmFrequencyTolerance(struct Imd *&imd_to_set,
                                       float tolerance) {
  TearDownObject(imd_to_set, App_Imd_Destroy);
  imd_to_set = App_Imd_Create(get_pwm_frequency, tolerance, get_pwm_duty_cycle,
...
void ImdTest::SetUp() {
  ...
  imd = App_Imd_Create(get_pwm_frequency, DEFAULT_FREQUENCY_TOLERANCE,
...
void ImdTest::TearDown() { TearDownObject(imd, App_Imd_Destroy); }
