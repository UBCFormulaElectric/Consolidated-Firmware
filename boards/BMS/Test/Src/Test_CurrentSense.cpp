...
TEST_F(CurrentSenseTest, main_current_1_calculation)
{
    ...
    ASSERT_EQ(
        ...
        Io_CurrentSense_ConvertToMainCurrent1(adc_voltage, &main_current_1));
    ...
    ASSERT_EQ(
        ...
        Io_CurrentSense_ConvertToMainCurrent1(adc_voltage, NULL));
}
...
TEST_F(CurrentSenseTest, main_current_2_calculation)
{
    ...
    ASSERT_EQ(
        EXIT_CODE_OUT_OF_RANGE,
        Io_CurrentSense_ConvertToMainCurrent2(adc_voltage, &main_current_2));
    ...
    ASSERT_EQ(
        EXIT_CODE_INVALID_ARGS,
        Io_CurrentSense_ConvertToMainCurrent2(adc_voltage, NULL));
}
