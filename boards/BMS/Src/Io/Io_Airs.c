...
// TODO: Remove static var and use these #defines to check if AIR positive has
// closed after HW issues are resolved
...
bool Io_Airs_IsAirPositiveClosed(void) { return is_air_positive_closed; }
