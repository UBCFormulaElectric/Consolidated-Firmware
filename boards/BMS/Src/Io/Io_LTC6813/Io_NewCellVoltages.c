...
static struct Voltages voltages = {
    .min     = { .voltage = 0xFFFFU, .cell = 0U, .segment = 0U },
    .max     = { .voltage = 0x0000U, .cell = 0U, .segment = 0U },
    .segment = { 0U },
    .pack    = 0U
};
...
static void Io_UpdateCellVoltages(void)
{
    struct Voltages temp_voltages = {
        .min     = { .segment = 0U, .cell = 0U, .voltage = 0xFFFFU },
