    ...
    bool (*is_charger_connected)(void))
{
    ...
    charger->is_charger_enabled = false;
...
{
    charger->is_charger_enabled = true;
    charger->enable();
}
...
bool App_Charger_IsChargerEnabled(const struct Charger *const charger)
{
    return charger->is_charger_enabled;
}
