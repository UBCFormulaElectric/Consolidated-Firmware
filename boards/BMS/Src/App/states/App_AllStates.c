...
void App_AllStatesRunOnTick100Hz(struct StateMachine *const state_machine)
{
    ...
    // App_BmsWorld_GetBmsOkStatus(world); struct OkStatus *         imd_ok =
    // App_BmsWorld_GetImdOkStatus(world); struct OkStatus *         bspd_ok =
    // App_BmsWorld_GetBspdOkStatus(world); struct Airs *             airs =
    // App_BmsWorld_GetAirs(world); struct ErrorTable *       error_table =
    // App_BmsWorld_GetErrorTable(world);
    ...
    App_Accumulator_PeriodicCanTx100Hz(accumulator, can_tx);
