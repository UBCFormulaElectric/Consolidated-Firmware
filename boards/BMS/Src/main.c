...
int main(void)
{
    ...
    accumulator = App_Accumulator_Create(
        ...
        Io_LTC6813CellVoltages_StartAdcConversion, Io_LTC6813CellVoltages_StartOpenWireCheck,
        Io_LTC6813CellVoltages_ReadVoltages, Io_LTC6813CellTemperatures_StartAdcConversion,
