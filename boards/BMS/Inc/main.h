...
#define AIR_POWER_STATUSB1_Pin GPIO_PIN_1
#define AIR_POWER_STATUSB1_GPIO_Port GPIOB
#define PRE_CHARGE_EN_Pin GPIO_PIN_2
#define PRE_CHARGE_EN_GPIO_Port GPIOB
#define AIRPLUS_EN_Pin GPIO_PIN_10
#define AIRPLUS_EN_GPIO_Port GPIOB
