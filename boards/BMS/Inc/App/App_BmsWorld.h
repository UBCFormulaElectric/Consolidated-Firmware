...
/**
 * Get the soc stats for the given world
 * @param world The world to get the accumulator for
 * @return The soc stats for the given world
 */
...
/**
 * Get the EEPROM for the given world
 * @param world The world to get EEPROM for
